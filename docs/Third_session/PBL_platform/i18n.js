...
(function (root, factory) {
  ...
  const T = {
    en: {
      ...
      "modA.chart.investigations.locked-hint": "🔒 Locked — add a working hypothesis above to unlock.",
    ...
    fr: {
      ...
      "modA.chart.investigations.locked-hint": "🔒 Verrouillé — ajoutez une hypothèse de travail ci-dessus pour débloquer.",
    ...
    ja: {
      ...
      "modA.chart.investigations.locked-hint": "🔒 ロック中 — 上に作業仮説を追加すると解除されます。",
