...
(function (root, factory) {
  ...
  "lobby.consent-version": "説明文書のバージョン: PIS v3 · 2026-07。",
  ...
  "splash.create.sections-required": "このセッションに少なくとも１つのセクションを追加してください。",
  ...
  "modA.answers.bullet.diagnosis.label": "1. あなたの診断と計画",
  "modA.answers.bullet.diagnosis.hint": "チームはどのように作業診断に至りましたか — 病歴・診察・検査の何が手がかりになり、何を除外しましたか?そのうえで、{patientName} に提案する第一選択の治療計画を述べてください。",
  "modA.answers.bullet.diagnosis.placeholder": "例:機械的腰痛;第一選択=活動維持＋NSAID＋安心の提供、オピオイドなし",
  ...
  "modA.chat.disclosure": "ベータ機能。言語モデルが{patientName}の役を担います。入力した質問は当方のサーバーおよび第三者の処理委託先である Hugging Face(米国・EU)に送信されます。<strong>氏名・連絡先・個人を特定できる情報を入力しないでください。</strong>実際の診察で尋ねる内容のみを入力してください。詳しくは<a href=\"privacy.html\" data-i18n-href=\"privacy\" target=\"_blank\" rel=\"noopener\">プライバシーポリシー</a>をご覧ください。",
