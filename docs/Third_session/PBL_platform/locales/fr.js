...
(function (root, factory) {
  ...
  "verify.not-found": "Cet identifiant de vérification n'est pas dans le registre public. Si vous l'avez reçu sur un certificat CaNaMED, veuillez contacter l'équipe CaNaMED avec l'identifiant et le nom figurant sur le certificat — elle détient le registre principal.",
  ...
  "lobby.consent-verification": "Je consens en outre à ce que mon certificat soit vérifiable de manière indépendante : un identifiant de vérification imprimé sur le certificat est lié, dans un registre séparé, à une empreinte unidirectionnelle (hachage) de mon nom et de la session, afin qu'un tiers à qui sont présentés À LA FOIS mon identifiant ET le nom y figurant puisse confirmer — sur une page publique du site CaNaMED — qu'ils correspondent à un véritable certificat CaNaMED. La page ne publie pas mon nom ; elle ne répond que « valide » ou « aucune correspondance » lorsque les deux informations sont fournies. Le registre est conservé jusqu'à 10 ans et je peux demander la suppression de mon entrée à tout moment (voir la politique de confidentialité, section 18). Je comprends que je peux participer et consentir à la recherche sans cocher cette troisième case.",
