...
// 8765 by default, but overridable via PORT so the suite can dodge a port
// collision (e.g. AnkiConnect also defaults to 127.0.0.1:8765). serve-platform.js
// already honours process.env.PORT, so both sides stay in lockstep.
...
module.exports = defineConfig({
  ...
  projects: [
    ...
    // ---- mobile / tablet device emulation pass ----
    {
      ...
      testMatch: /(?:mobile|deep-link-session-override|lazy-locale-consent|survey-feedback|lobby-form-semantics|lobby-join-density|facilitator-profile|modb-role-objective|case-cluster-by-category|investigations-anytime|chart-tabs|modA-autoopen-steps|modA-rcol-progressive|modA-llm-stub|modA-triage|modA-chat-controls|modA-scenario-persona|modA-switchboard|modA-chat-per-slot|mayumi-session|modb-phase-flow|modb-exchange-answers|student-pdf|verify-page|splash-authored-scenarios|scenario-snapshot|scenario-author-coverage|mobile-bottom-tabbar|vote-tally-access|glossary-marker-tap|lang-reader|control-row-overflow|reference-toolbar|stage-ui-fixes|modab-2026-06-02-fixes|modab-role-sections|modb-improvements|live-leaderboard|admin-toolbar-declutter|close-abandoned-sessions|user-feedback|branched-format|branched-session-framing|room-header-collapse|wrapup-consolidation|moderation-ui|room-css-lazy|section-stage-labels|section-picker|splash-overflow|mixed-session-e2e|cross-module-gate|retention-notice|consent-transcript|create-form-authoring|admin-choice-tree|author-format-split|authoring-integrity|section-row-change|roleplay-authoring|roleplay-authored-e2e|section-session-identity|takehome-lazy|admin-lazy|answers-bucket-routing|org-session-e2e|i18n-placeholder-substitution|lobby-agenda-q1-dedupe|withdraw-consent-ui|data-rights-lazy|modA-chat-closed|modA-chat-wait)\.spec\.js$/
    },
    {
      name: "mobile-ipad",
    ...
    // answer is both in the DOM AND scrolled into the viewport.
    {
      name: "mobile-android",
      use: { ...devices["Pixel 7"] },
      testMatch: /(?:android-findings|deep-link-session-override|lazy-locale-consent|survey-feedback|lobby-form-semantics|lobby-join-density|facilitator-profile|modb-role-objective|case-cluster-by-category|investigations-anytime|chart-tabs|modA-autoopen-steps|modA-rcol-progressive|modA-llm-stub|modA-triage|modA-chat-controls|modA-scenario-persona|modA-switchboard|modA-chat-per-slot|mayumi-session|modb-phase-flow|modb-exchange-answers|student-pdf|verify-page|splash-authored-scenarios|scenario-snapshot|scenario-author-coverage|mobile-bottom-tabbar|vote-tally-access|glossary-marker-tap|lang-reader|control-row-overflow|reference-toolbar|stage-ui-fixes|modab-2026-06-02-fixes|modab-role-sections|modb-improvements|live-leaderboard|admin-toolbar-declutter|close-abandoned-sessions|user-feedback|branched-format|branched-session-framing|room-header-collapse|wrapup-consolidation|moderation-ui|room-css-lazy|section-stage-labels|section-picker|splash-overflow|mixed-session-e2e|cross-module-gate|retention-notice|consent-transcript|create-form-authoring|admin-choice-tree|author-format-split|authoring-integrity|section-row-change|roleplay-authoring|roleplay-authored-e2e|section-session-identity|takehome-lazy|admin-lazy|answers-bucket-routing|org-session-e2e|i18n-placeholder-substitution|lobby-agenda-q1-dedupe|withdraw-consent-ui|data-rights-lazy|modA-chat-closed|modA-chat-wait)\.spec\.js$/
    }
  ],
