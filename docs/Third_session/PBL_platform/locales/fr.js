...
(function (root, factory) {
  ...
  "modA.answers.title": "Discuter ensemble — Module A",
  "modA.answers.rule": "🗣️ <strong>En groupe, discutez ensemble du cas</strong> — y compris les différences de prise en charge de la douleur entre la France et le Japon — puis notez votre réponse dans les deux champs ci-dessous.",
  ...
  "modA.answers.bullet.differ.label": "2. Une <strong>différence culturelle</strong> entre la France et le Japon dans la <strong>prise en charge de la douleur</strong>",
  "modA.answers.bullet.differ.placeholder": "ex. la facilité de prescription des opioïdes forts ; les attentes des patients ; la réglementation",
  ...
  "modA.answers.complete.msg": "✓ Vos deux réponses sont prêtes. Prêt·e pour le jeu de rôle ?",
  ...
  "modA.decision.unlock.synthesis": "écrire deux hypothèses de travail",
  ...
  "modA.chart.hypotheses.hint": "Mettez-vous d'accord en équipe : <strong>qu'est-ce que vous suspectez ?</strong> Listez <strong>deux diagnostics différentiels ou plus</strong> à confirmer ou à éliminer. En écrire deux débloque les questions de discussion.",
  ...
  "modA.coach.open-discussion": "✓ Hypothèse posée — ouvrez « Discuter ensemble ». En groupe, discutez du cas et des différences de prise en charge de la douleur entre la France et le Japon, puis notez votre plan et la différence clé.",
  ...
  "modA.coach.bullets-partial": "Saisie de votre réponse — encore {n} à ajouter (votre plan + la différence France/Japon).",
  "modA.coach.bullets-complete": "✓ Vos deux réponses sont enregistrées. Ajoutez des précisions ou attendez votre encadrant·e.",
  ...
  "rcol.tab.answers": "Discuter ensemble",
  "rcol.tab.reference": "Référence",
  "rcol.tab.discussion.locked": "🔒 écrire 2 hypothèses pour débloquer",
  ...
  "prompts.locked": "Verrouillé — écrivez au moins deux hypothèses de travail pour débloquer les questions de discussion.",
