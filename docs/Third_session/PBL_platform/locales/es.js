...
(function (root, factory) {
  ...
  "lobby.consent-transcript": "Consiento además que la transcripción escrita Y la grabación de audio/vídeo de las sesiones celebradas por videoconferencia se conserven y analicen para el estudio CaNaMED. La transcripción la genera automáticamente la herramienta de videoconferencia (Microsoft Teams) y lleva mi nombre junto a cada una de mis intervenciones; la grabación de la sesión también se conserva, no solo la transcripción. Ambas se conservan durante 5 años después de la publicación, con el mismo acceso restringido que el resto del conjunto de datos de investigación, y puedo solicitar su supresión en cualquier momento. No se toma ninguna fotografía y no estoy obligado a encender la cámara. Puedo participar en el taller sin marcar esta tercera casilla y sin marcar la casilla de investigación anterior — negarme no tiene ningún efecto sobre mi participación, mis notas ni mi situación en la universidad.",
  "lobby.consent-version": "Versión del aviso PIS v11 · 2026-09. ",
  ...
  "lobby.privacy.controller-default": "El equipo de investigación CaNaMED (<strong>Université de Caen Normandie × Universidad de Nagoya</strong>, corresponsables del tratamiento según el art. 26 RGPD / usuarios conjuntos según el art. 27(5) APPI)",
  "lobby.privacy.controller-named": "<strong>{name}</strong>, responsable del tratamiento en esta sesión,",
  "lobby.privacy.p1": "{controller} recopila su nombre o apodo, universidad, año de estudios y nivel de inglés autoevaluado. Su nombre es visible para todas las personas de su sala y aparece junto a los puntos que aporta.",
  ...
  "lobby.privacy.p3": "Los datos se almacenan en Google Firebase Realtime Database en <strong>europe-west1 (Bélgica, UE)</strong>. Para los participantes japoneses se trata de una transferencia transfronteriza protegida por la decisión de adecuación mutua UE–Japón (PPC, 2019). Los datos de la sesión en vivo se eliminan en un plazo de 30 días tras el cierre de la sesión, o de 90 días desde su creación si la sesión nunca se cierra; si marcó la casilla de consentimiento para investigación, sus contribuciones se conservan vinculadas a usted (de forma identificable) hasta 5 años después de la publicación. Una copia permanece además en nuestras copias de seguridad nocturnas hasta 90 días después de realizarse, por lo que la última copia de una sesión desaparece unos 120 días tras su cierre; las copias de seguridad solo se usan para restablecer el servicio tras un incidente, nunca para consultar datos.",
  "lobby.privacy.transcript": "Las sesiones se celebran por <strong>videoconferencia en Microsoft Teams</strong>, dentro de la suscripción de su universidad — <strong>Microsoft</strong> actúa como encargado del tratamiento junto a Google. La herramienta genera <strong>automáticamente una transcripción escrita</strong> que lleva su nombre junto a cada cosa que dice; la grabación de audio/vídeo de la sesión también se conserva, no solo la transcripción. La transcripción y la grabación se conservan <strong>únicamente si marca la tercera casilla de consentimiento</strong>: durante 5 años después de la publicación, con el mismo acceso restringido que el resto del conjunto de datos de investigación, y puede solicitar su supresión en cualquier momento. <strong>No se toma ninguna fotografía y no está obligado a encender la cámara.</strong>",
  ...
  "splash.create.sections-help": "Las secciones de hoy, en orden. Siempre se incluyen una apertura y un cierre.",
  "splash.create.sections-empty": "No sections yet — add at least one.",
  "splash.create.sections-add-label": "Añadir una sola sección",
  "splash.create.sections-add": "+ Añadir una sección",
  "splash.create.case-label": "Caso",
  "splash.create.case-help": "Elija un caso, marque las partes que hará hoy y añádalas. Abajo podrá reordenarlas o quitarlas, y mezclar partes de otros casos.",
  "splash.create.case-add": "+ Añadir las partes marcadas",
  "splash.create.case-full": "Añadidas {added} de {wanted} — una sesión tiene como máximo {max} secciones",
  "splash.create.sections-full": "La sesión está completa — como máximo {max} secciones",
  ...
  "stage.label.welcome": "Bienvenida",
  "stage.label.wrapup": "Cierre",
  "stage.label.section": "Sección {n} — {title}",
  "stage.label.0": "Bienvenida",
  "stage.label.4": "Cierre",
