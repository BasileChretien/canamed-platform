...
(function (root, factory) {
  ...
  const T = {
    en: {
      ...
      "modA.answers.title": "Discuss together — Module A",
      "modA.answers.rule": "🗣️ <strong>As a group, discuss the case together</strong> — including how pain management differs between France and Japan — then capture your answer in the two boxes below.",
      ...
      "modA.answers.bullet.differ.label": "2. A <strong>cultural difference</strong> between France and Japan in <strong>pain management</strong>",
      "modA.answers.bullet.differ.placeholder": "e.g. how readily strong opioids are prescribed; patient expectations; regulation",
      ...
      "modA.chart.hypotheses.hint": "Agree as a team: <strong>what do you suspect?</strong> List <strong>one or more</strong> differentials you want to rule in or rule out. Writing one unlocks the discussion.",
      ...
      "modA.coach.open-discussion": "✓ Hypothesis in — open “Discuss together”. As a group, discuss the case and how pain management differs between France and Japan, then capture your plan and the key difference.",      "modA.coach.bullets-partial": "Capturing your answer — {n} still to add (your plan + the France/Japan difference).",
      "modA.coach.bullets-complete": "✓ Both answers captured. Add more or wait for your facilitator.",      "modB.coach.pick-role": "Read the situation together, then take a seat below — there's no wrong choice, and you'll swap roles and replay.",
      ...
      "tour.studentModA.1.body": "This coach tells your team what to do next at each step. Start by reading the case, then use the buttons on the left to ask the patient, examine, and order any tests.",
      ...
      "rcol.tab.answers": "Discuss together",
