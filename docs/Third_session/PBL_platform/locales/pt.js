...
(function (root, factory) {
  ...
  "lobby.consent-transcript": "Consinto ainda que a transcrição escrita E a gravação de áudio/vídeo das sessões realizadas por videoconferência sejam conservadas e analisadas para o estudo CaNaMED. A transcrição é produzida automaticamente pela ferramenta de videoconferência (Microsoft Teams) e apresenta o meu nome junto a cada uma das minhas intervenções; a gravação da sessão é igualmente conservada, e não apenas a transcrição. Ambas são conservadas durante 5 anos após a publicação, com o mesmo acesso restrito que o restante do conjunto de dados de investigação, e posso pedir a sua eliminação a qualquer momento. Não é tirada qualquer fotografia e não sou obrigado a ligar a câmara. Posso participar no workshop sem assinalar esta terceira caixa e sem assinalar a caixa de investigação acima — recusar não tem qualquer efeito na minha participação, nas minhas notas ou na minha situação na universidade.",
  "lobby.consent-version": "Versão do aviso PIS v11 · 2026-09. ",
  ...
  "lobby.privacy.controller-default": "A equipe de pesquisa CaNaMED (<strong>Université de Caen Normandie × Universidade de Nagoya</strong>, controladores conjuntos nos termos do art. 26 do RGPD / usuários conjuntos nos termos do art. 27(5) da APPI)",
  "lobby.privacy.controller-named": "<strong>{name}</strong>, responsável pelo tratamento nesta sessão,",
  "lobby.privacy.p1": "{controller} coleta seu primeiro nome ou apelido, universidade, ano de estudo e nível de inglês autoavaliado. Seu nome é visível para todas as pessoas da sua sala e aparece ao lado dos pontos que você contribui.",
  ...
  "lobby.privacy.p3": "Os dados são armazenados no Google Firebase Realtime Database em <strong>europe-west1 (Bélgica, UE)</strong>. Para os participantes japoneses trata-se de uma transferência transfronteiriça protegida pela decisão de adequação mútua UE–Japão (PPC, 2019). Os dados da sessão ao vivo são apagados em até 30 dias após o encerramento da sessão, ou em até 90 dias após a criação se a sessão nunca for encerrada; se você marcou a caixa de consentimento de pesquisa, suas contribuições são mantidas vinculadas a você (de forma identificável) por até 5 anos após a publicação. Uma cópia permanece ainda nos nossos backups noturnos por até 90 dias após serem feitos, pelo que a última cópia de uma sessão desaparece cerca de 120 dias após o encerramento; os backups servem apenas para restabelecer o serviço após um incidente, nunca para consultar dados.",
  "lobby.privacy.transcript": "As sessões decorrem por <strong>videoconferência no Microsoft Teams</strong>, ao abrigo da subscrição da sua universidade — a <strong>Microsoft</strong> é subcontratante para este efeito, a par da Google. A ferramenta produz <strong>automaticamente uma transcrição escrita</strong>, que apresenta o seu nome junto a cada coisa que diz; a gravação de áudio/vídeo da sessão é igualmente conservada, e não apenas a transcrição. A transcrição e a gravação só são conservadas <strong>se assinalar a terceira caixa de consentimento</strong> — durante 5 anos após a publicação, com o mesmo acesso restrito que o restante do conjunto de dados de investigação, e pode pedir a sua eliminação a qualquer momento. <strong>Não é tirada qualquer fotografia e não é obrigado a ligar a câmara.</strong>",
  ...
  "splash.create.sections-help": "As secções de hoje, por ordem. Uma abertura e um encerramento estão sempre incluídos.",
  "splash.create.sections-empty": "No sections yet — add at least one.",
  "splash.create.sections-add-label": "Adicionar uma única secção",
  "splash.create.sections-add": "+ Adicionar uma secção",
  "splash.create.case-label": "Caso",
  "splash.create.case-help": "Escolha um caso, marque as partes que fará hoje e adicione-as. Abaixo pode reordená-las ou removê-las, e misturar partes de outros casos.",
  "splash.create.case-add": "+ Adicionar as partes marcadas",
  "splash.create.case-full": "Adicionadas {added} de {wanted} — uma sessão tem no máximo {max} secções",
  "splash.create.sections-full": "A sessão está cheia — no máximo {max} secções",
  ...
  "stage.label.welcome": "Boas-vindas",
  "stage.label.wrapup": "Encerramento",
  "stage.label.section": "Secção {n} — {title}",
  "stage.label.0": "Boas-vindas",
  "stage.label.4": "Encerramento",
