...
(function (root, factory) {
  ...
  "modA.chart.hypotheses.hint": "チームで合意してください: <strong>何を疑いますか?</strong> 確定したいまたは除外したい鑑別診断を<strong>2つ以上</strong>挙げましょう。2つ書くと臨床的総合判断とディスカッション項目が解禁されます。",
  ...
  "modA.chart.synthesis.title": "臨床的総合判断",
  "modA.chart.synthesis.locked-hint": "上で作業仮説を<strong>2つ以上</strong>書くと、臨床的総合判断とディスカッション項目が解禁されます。",
  ...
  "modA.coach.gather": "ケースを整理しましょう — 問診・診察・検査を行い、準備ができたら作業仮説を2つ書いて、臨床的総合判断とディスカッションを解放してください。",
  "modA.coach.open-discussion": "✓ 仮説が出そろいました — 臨床的総合判断と議論(Debate)が開きました。総合判断を行ってから設問を議論しましょう(各比較設問でCaenと名古屋の両方の声を)。",
  ...
  "modA.synthesis.unlocked": "✓ レッドフラッグの確認完了。",
  "findings.title": "所見ログ",
