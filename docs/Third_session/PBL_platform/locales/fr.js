...
(function (root, factory) {
  ...
  "modA.coach.open-discussion": "✓ Hypothèse posée — ouvrez « Discuter ensemble ». En groupe, discutez du cas et des différences de prise en charge de la douleur entre la France et le Japon, puis notez votre plan et la différence clé.",  "modA.coach.bullets-partial": "Saisie de votre réponse — encore {n} à ajouter (votre plan + la différence France/Japon).",
  "modA.coach.bullets-complete": "✓ Vos deux réponses sont enregistrées. Ajoutez des précisions ou attendez votre encadrant·e.",  "modB.coach.pick-role": "Lisez la situation ensemble, puis prenez place ci-dessous — aucun mauvais choix, et vous échangerez les rôles pour rejouer.",
