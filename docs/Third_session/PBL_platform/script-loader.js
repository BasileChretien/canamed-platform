    ...
    return loadScript(v("case-content.js")).then(function () {
      ...
      return Promise.all([
        ...
        loadScript(v("branched-seed.js"))
          /* mayumi-seed.js registers the six "A Difficult Child" PBL sections
             the same way; it must precede the registry for them to exist. */
          .then(function () { return loadScript(v("mayumi-seed.js")); })
