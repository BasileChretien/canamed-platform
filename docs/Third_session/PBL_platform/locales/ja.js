...
(function (root, factory) {
  ...
  "splash.create.controller-label": "個人データの管理者 (所属機関)",
  "splash.create.controller-placeholder": "例: カーン・ノルマンディー大学",
  "splash.create.controller-hint": "このセッションにおける参加者のデータについて責任を負う組織として、参加者に表示されます。",
  "splash.create.controller-required": "このセッションのデータに責任を負う機関を入力してください。参加前に参加者へ表示されます。",
  "lobby.privacy.controller-plain": "カーン・ノルマンディー大学 × 名古屋大学",
  ...
  "splash.create.report": "このシナリオを報告",
  "splash.create.report-title": "このシナリオを報告しますか？",
  "splash.create.report-confirm": "モデレーターがこのシナリオを確認します。報告は一度だけ可能です。",
  "splash.create.reported": "報告しました。ありがとうございます。",
  "splash.create.report-sent": "モデレーターに報告を送信しました",
  "splash.create.report-signin": "シナリオを報告するにはログインしてください",
  "splash.create.report-failed": "報告を送信できませんでした。もう一度お試しください。",
  ...
  "lobby.consent-transcript": "さらに、ビデオ会議で実施されるセッションの書き起こし（文字起こし）および音声・映像の記録を、CaNaMED研究のために保存・分析することに同意します。書き起こしはビデオ会議ツール（Microsoft Teams）が自動的に作成し、私の発言ごとに私の名前が付きます。書き起こしだけでなく、セッションの記録も保存されます。いずれも公表から5年間、研究データセットの他の部分と同じ制限されたアクセス範囲で保管され、私はいつでも削除を求めることができます。写真は撮影されず、カメラをオンにする義務もありません。この3つ目の欄にチェックしなくても、また上の研究の欄にチェックしなくても、セッションに参加できます。拒否しても、参加、成績、大学での立場に一切影響しません。",
  ...
  "lobby.consent-version": "説明文書のバージョン: PIS v11 · 2026-09。",
  ...
  "lobby.privacy.controller-default": "CaNaMED研究チーム (<strong>カーン・ノルマンディー大学 × 名古屋大学</strong>、GDPR第26条上の共同管理者 / APPI第27条(5)上の共同利用者)",
  "lobby.privacy.controller-named": "<strong>{name}</strong> (このセッションの個人データ管理者)",
  "lobby.privacy.p1": "{controller} は、皆さんの名前またはニックネーム、所属大学、学年、自己評価による英語レベルを収集します。お名前は同じルームの全員に表示され、貢献したポイントの横に並んで表示されます。",
  ...
  "lobby.privacy.p3": "データは Google Firebase Realtime Database (<strong>europe-west1, ベルギー, EU</strong>) に保存されます。日本の参加者にとっては越境移転にあたりますが、EU・日本相互の十分性認定 (個人情報保護委員会, 2019年) によって保護されます。ライブセッションのデータはセッション終了から30日以内に削除されます (終了操作が行われないまま放置された場合は、作成から90日以内に削除されます)。研究利用への同意ボックスにチェックを入れた場合、皆さんの貢献内容はご本人と紐づけた (個人を特定できる) 形で論文公表後最長5年間保持されます。なお、複製は毎晩のバックアップにも作成から最長90日間残るため、セッションの最後の複製が消えるのは終了から約120日後となります。バックアップは障害からのサービス復旧のみに使用し、データの検索には使用しません。",
  "lobby.privacy.transcript": "セッションは大学の契約に基づく<strong>Microsoft Teams のビデオ会議</strong>で実施され、これについては Google と並んで <strong>Microsoft</strong> が委託先となります。ツールは<strong>書き起こし（文字起こし）を自動的に作成</strong>し、あなたの発言ごとにあなたの名前が付きます。書き起こしだけでなく、セッションの音声・映像の記録も保存されます。書き起こしと記録は<strong>3つ目の同意欄にチェックした場合に限り</strong>保存され、公表から5年間、研究データセットの他の部分と同じ制限されたアクセス範囲で保管されます。いつでも削除を求めることができます。<strong>写真は撮影されず、カメラをオンにする義務もありません。</strong>",
  ...
  "data-rights.withdraw-btn": "研究利用への同意を撤回する",
  "data-rights.withdraw-btn-short": "同意を撤回",
  "data-rights.withdraw-title": "研究利用への同意を撤回しますか？",
  "data-rights.withdraw-confirm": "あなたの貢献内容は研究データセットから除外されます。セッションへの参加、成績、大学における取り扱いには影響しません。",
  "data-rights.withdraw-detail": "プラットフォームからのデータ削除も行います。これは自動ではなく担当者が実施します。稼働中のデータは数営業日以内に削除され、毎晩のバックアップ内の複製は90日以内に失効します（その間に使用されることはありません）。撤回しても、すでに公表された研究が取り消されるわけではありません。",
  "data-rights.withdraw-ok": "同意を撤回する",
  "data-rights.withdraw-done": "撤回を受け付けました。研究データセットからは除外され、削除のご希望も記録されました。",
  "data-rights.withdraw-err": "撤回を記録できませんでした。もう一度お試しいただくか、ファシリテーターまたはDPOにご連絡ください。",
  "data-rights.withdraw-err-auth": "サインインがまだ完了していません。少し経ってからお試しください。",
  ...
  "splash.create.sections-label": "実施するセクション",
  "splash.create.sections-help": "今日のセクション(実施順)。導入とまとめは常に含まれます。",
  "splash.create.sections-empty": "セクションがまだありません — 少なくとも1つ追加してください。",
  "splash.create.sections-add-label": "セクションを1つ追加",
  "splash.create.sections-add": "+ セクションを1つ追加",
  "splash.create.case-label": "症例",
  "splash.create.case-help": "症例を選び、今日行うパートにチェックを入れて追加してください。下で並べ替えや削除ができ、他の症例のパートを混ぜることもできます。",
  "splash.create.case-add": "+ チェックしたパートを追加",
  "splash.create.case-full": "{wanted}件中{added}件を追加しました — 1セッションは最大{max}セクションです",
  "splash.create.sections-full": "セッションは満杯です — 最大{max}セクション",
  ...
  "stage.label.welcome": "ようこそ",
  "stage.label.wrapup": "まとめ",
  "stage.label.section": "セクション{n} — {title}",
  "stage.label.0": "ようこそ",
  "stage.label.4": "まとめ",
  ...
  "room.answers.hint.moduleB": "ルームの誰でもポイントを追加できます — 自動的に保存されます。上の項目をカバーしましょう。フランスと日本の双方から書き込んでください。",
  ...
  "admin.links.summary": "セッションリンク — Teams・アンケート",
  "admin.archive.label": "アーカイブをダウンロード:",
  ...
  "stage.modB.intro.hint": "このモジュールはグループで進めるロールプレイです。観察者が時間を計りながら、六つのフェーズを順に進めてください。",
  "stage.modB.phase1.title": "フェーズ1 — 準備 (5分)",
  ...
  // stage.modB.spikes.* mnemonic-strip keys は 2026-06-26 に削除 (SPIKES バンドを撤去)。
  ...
  "stage.modB.phase2.title": "フェーズ2 — 演じる (15分)",
  "stage.modB.phase2.intro": "観察者が「start」と言ったら、患者はすでに座っている状態で医師が始めます。医師は知らせを伝え、その場で家族の頼みにも対応します。観察者は黙って見守り、終わりに「time」と告げます。後のフェーズで役割を交代し、この場面をもう一度演じます。",
  ...
  "stage.modB.phase3.title": "フェーズ3 — 対話 (10分)",
  "stage.modB.phase3.ground-rule": "<strong>基本ルール:</strong> 私たちは <em>診療実践とその変化</em> を比べているのであって、国に順位をつけているのではありません。どちらのモデルも「進んでいる方」ではありません。実際に見たこと、学んだことを話してください — 「よく分からない、今変わりつつある」と言うのもまったく構いません。",
  "stage.modB.exchange.title": "フェーズ3 — 話し合って投票する",
  "stage.modB.phase4.title": "フェーズ4 — 役割交代＆再演 (2分)",
  "stage.modB.swap.title": "フェーズ4 — 役割を交代して再演する",
  "stage.modB.swap.body": "一度演じて話し合いました。次は <strong>交代</strong> です：全員が次の役割に回り、同じ場面を反対側から演じ直します — そこで共感が本当に深まります。<strong>「交代」</strong> を押すと、役割チップと「あなたの役割」タブが自動で更新されます。",
  "stage.modB.phase5.title": "フェーズ5 — 再演 (8分)",
  "stage.modB.replay.title": "フェーズ5 — 再演 (2回目)",
  "stage.modB.replay.body": "<strong>新しい役割</strong> で <strong>同じ場面</strong> をもう一度演じます。完璧を目指さず、別の立場から見た今、何を <em>違うふうに</em> するかに気づいてください。役割と非公開のブリーフは <strong>「あなたの役割」</strong> タブにあります。",
  "stage.modB.phase6.title": "フェーズ6 — 何が良くなったか (6分)",
  "stage.modB.reflect.title": "フェーズ6 — 何が良くなったか",
  "stage.modB.reflect.intro": "両方の側から2回演じました。何が変わったかを一緒に振り返り — 各自、持ち帰ることを一つ書きましょう。",
  "modB.phase.prev": "← 前へ",
  "modB.phase.next": "次へ →",
  "modB.phase.indicator": "フェーズ {n} / 6",
  ...
  "modA.discussion.compare-rule": "<strong>比較項目:</strong> 次に進む前に、Caenと名古屋の両方の声が発言する必要があります。早く合意することではなく、比較し議論することが目的です。",
  ...
  "modA.answers.bullet.diagnosis.label": "1. あなたの作業診断",
  "modA.answers.bullet.diagnosis.hint": "チームはどのように作業診断に至りましたか — 病歴・診察・検査の何が手がかりになり、何を除外しましたか?",
  "modA.answers.bullet.diagnosis.placeholder": "例:機械的腰痛;病歴と診察でレッドフラッグを除外",
  "modA.answers.bullet.culture.label": "2. 文化によって異なる痛み",
  "modA.answers.bullet.culture.hint": "国(例:フランスと日本)による痛みへの向き合い方を比較しましょう — 痛みに対する文化的態度、オピオイドの処方されやすさと処方者、そしてWHO三段階除痛ラダー(<em>Palier 1 → 3</em>)の各段階で通常用いられる薬と用量。どこが本当に異なりますか?",
  "modA.answers.bullet.culture.placeholder": "例:日本はフランスより大幅にオピオイド処方が少ない;第1段階 パラセタモール/NSAID、第2段階 コデイン/トラマドール、第3段階 モルヒネ",
  "modA.answers.bullet.culture.who-link": "↗ WHO三段階除痛ラダー(参考)",
  ...
  "modB.phase.setup.time": "5分",
  "modB.phase.play.time": "15分",
  "modB.phase.exchange.time": "10分",
  "modB.phase.swap.time": "2分",
  "modB.phase.replay.time": "8分",
  "modB.phase.reflect.time": "6分",
  "modB.roles.prompt": "<strong>役割を選んでください</strong> — このロールプレイのために。名前のついた役割を持たない人は観察者 (タイムキーパー + フェーズ3の司会) となります。",
  "modB.roles.assign": "役割をランダムに割り当てる",
  "modB.role.card.prompt": "<strong>上で役割を選ぶ</strong>(または「役割をランダムに割り当てる」をタップ)と、ここにあなたの担当と非公開のブリーフが表示されます。",
  ...
  "modB.answers.bullet.family-sentence.label": "1. 家族から情報を <strong>伏せて</strong> ほしいと頼まれたとき、あなたはどうしましたか — そして <strong>フランス</strong> の医師は <strong>日本</strong> の医師と同じように対応するでしょうか?",
  ...
  "modB.answers.bullet.reflect-improved.label": "1. 2回目に <strong>違うふうに</strong> したことは何ですか — そして反対の立場を演じて何を学びましたか?",
  "modB.answers.bullet.reflect-improved.placeholder": "例: 患者役として医師がいかに急いでいたかに気づき、2回目はもっと間を取った",
  "modB.answers.bullet.practice-change.label": "2. これを受けて、それぞれが自国で違うふうにしようと思うこと",
  "modB.answers.bullet.practice-change.placeholder": "一人一文",
  "modB.answers.bullet.unsorted.label": "その他の項目 (まだ要点に紐付いていないもの)",
  "modB.answers.complete.msg": "✓ すべての回答が揃いました。まとめに入りますか？",
  ...
  "reference.btn.yourrole": "あなたの役割",
  "reference.btn.useful": "役立つフレーズ",
  "reference.btn.history": "歴史的背景",
  "reference.btn.guidelines": "ガイドライン",
  "reference.btn.recap": "早見表",
  "backToTop.label": "トップへ戻る",
  "modA.chart.title": "あなたのコンサルテーションノート — <em>{patientName}</em>、本日",
  // 2026-06-01 統合：「共有カルテ」の枠組み（旧 modA.chart.subtitle、廃止）と
  // 「クリックはすべてチームの意思決定」のルールをこの 1 行に集約。
  "modA.chart.team-click-warning": "<strong>{patientName}の共有カルテです。</strong> チームが問診・診察・検査・決定したことはすべて<em>ルームの全員</em>に記録され、チームの選択として扱われます。<strong>まず話し合ってから、一緒にクリックしてください。</strong>",
  ...
  "modA.decision.unlock.synthesis": "作業仮説を1つ書く",
  ...
  "modA.chart.hypotheses.hint": "チームで合意してください: <strong>何を疑いますか?</strong> 確定したいまたは除外したい鑑別診断を挙げましょう。<strong>1つ</strong>書くとディスカッション項目が解禁されます。",
  ...
  "modA.chat.disclosure": "ベータ機能。言語モデルが{patientName}の役を担います。入力した質問は Scaleway(パリ)が中継し、Hugging Face(EEA域外)を経て OVHcloud(グラヴリーヌ)に送信されます。いずれも第三者の処理委託先です。<strong>氏名・連絡先・個人を特定できる情報を入力しないでください。</strong>実際の診察で尋ねる内容のみを入力してください。詳しくは<a href=\"privacy.html\" data-i18n-href=\"privacy\" target=\"_blank\" rel=\"noopener\">プライバシーポリシー</a>をご覧ください。",
  "modA.chat.consentCta": "理解しました — 診察を開始する",
  "modA.chat.consentRequired": "最初の質問を送信する前に、上記の説明をご確認のうえ同意してください。",
  "modA.chat.placeholder": "{patientName}に質問してください…",
  "modA.chat.send": "送信",
  ...
  "modA.chart.tabs.aria": "患者の評価",
  "modA.chart.tabs.dialogue": "対話",
  "modA.chart.tabs.dialogue.unread": "新しい返信",
  ...
  "modA.coach.read-case": "症例を読んでから、{patientName}に問診し、診察・検査をしてケースを整理しましょう。",
  "modA.coach.gather": "ケースを整理しましょう — 問診・診察・検査を行い、準備ができたら作業仮説を1つ書いてディスカッションを解放してください。",
  ...
  "modB.coach.roleplay": "役割が決まりました! 場面を演じ、話し合って投票しましょう — そして役割を交代して再演します。",
  "modB.coach.bullets-partial": "回答を記録中 — あと{n}つ追加が必要です。",
  "modB.coach.bullets-complete": "✓ すべての回答が記録されました。さらに加筆するか、ファシリテーターをお待ちください。",
  "stage.wrap.title": "まとめと次のステップ",
  "stage.wrap.thanks": "ご参加ありがとうございました。",
  ...
  "survey.preview-intro": "ファシリテーター用プレビュー — これは学生がセッション終了時に回答するアンケートです。ここで入力した内容は保存されません。",
  "survey.preview-note": "ファシリテーター用プレビュー — 学生がセッション終了時に回答します。ここでは何も保存されません。",
  ...
  "impact.research": "研究データ書き出し（JSON）",
  "impact.research-csv": "研究データ書き出し（CSV）",
  "impact.roster": "メール名簿（CSV）",
  "impact.attest": "修了証",
  "impact.revoke-cert": "検証エントリを削除",
  ...
  "tour.create.2.title": "セクションを選択",
  "tour.create.2.body": "このセッションで行う部分を、希望する順序で追加します — 異なる臨床症例から選ぶこともできます。自分で作る場合は、一覧の下にある作成ボードのリンクから。",
  ...
  "rcol.tab.discussion.locked": "仮説を1つ書いて解除",
  "findings.title": "所見ログ",
  "findings.empty": "まだ何も尋ねていません。左のボタンを使って症例を進めてください。",
  "prompts.title": "ディスカッションの設問",
  "prompts.locked": "ロック中 — 作業仮説を1つ書くとディスカッションの設問が解放されます。",
