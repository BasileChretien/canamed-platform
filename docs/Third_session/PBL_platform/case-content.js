...
var DECISIONS_B = [
  ...
  {
    id: "dec_stage_first", module: "A", points: 25, penalty: 0,
    prompt: { en: "The ultrasound shows a dilated biliary tree and a suspicious mass in the pancreatic head. Bilirubin 210 µmol/L, ALP 640 U/L. She is itching badly but is not septic. What does your team order next?",
              fr: "L'échographie montre une dilatation des voies biliaires et une masse suspecte de la tête du pancréas. Bilirubine 210 µmol/L, PAL 640 UI/L. Elle a un prurit important mais n'est pas septique. Que prescrit votre équipe ?",
              ja: "超音波で胆管拡張と膵頭部の疑わしい腫瘤を認めます。ビリルビン210 µmol/L、ALP 640 U/L。掻痒は強いものの敗血症はありません。チームは次に何をオーダーしますか?" },
    options: [
      { text: { en: "Pancreatic-protocol contrast CT for staging, BEFORE any biliary intervention",
        ...
        correct: true,
        why: { en: "Staging first preserves the information you need. A stent introduces inflammatory change and artefact that degrade assessment of vascular involvement, and ERCP carries a pancreatitis risk — so a decision taken for comfort can cost the resectability question.",
             fr: "Faire le bilan d'abord préserve l'information nécessaire. La prothèse induit des remaniements inflammatoires et des artefacts qui dégradent l'évaluation de l'atteinte vasculaire, et la CPRE expose à une pancréatite : un geste décidé pour le confort peut faire perdre la question de la résécabilité.",
             ja: "先に病期診断を行うことで必要な情報が保たれます。ステントは炎症性変化とアーチファクトを生じて血管浸潤の評価を損ない、ERCPには膵炎のリスクがあります。快適さのための判断が切除可能性の問いを失わせうるのです。" } },
