...
module.exports = defineConfig({
  ...
  projects: [
    ...
    // ---- mobile / tablet device emulation pass ----
    {
      ...
      testMatch: /(?:mobile|lazy-locale-consent|survey-feedback|lobby-form-semantics)\.spec\.js$/
    },
    {
      name: "mobile-ipad",
    ...
    // answer is both in the DOM AND scrolled into the viewport.
    {
      name: "mobile-android",
      use: { ...devices["Pixel 7"] },
      testMatch: /(?:android-findings|lazy-locale-consent|survey-feedback|lobby-form-semantics)\.spec\.js$/
    }
  ],
