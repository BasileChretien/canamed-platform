...
(function (root, factory) {
  ...
  "splash.enter.go-account": "Google 또는 이메일로 로그인하여 프로필과 기록 저장하기 →",
  "splash.enter.go-author": "나만의 시나리오 작성 또는 편집 →",
  "splash.account.title": "계정에 로그인",
  "splash.account.subtitle": "Google 또는 이메일과 비밀번호로 로그인하세요. 세션에 참여할 때 정보가 자동으로 입력되며, 참여하신 세션 기록과 작성하신 시나리오는 프로필에 보관됩니다.",
  "splash.account.continue-google": "Google로 계속하기",
  "splash.account.or": "— 또는 이메일로 —",
  "splash.account.email-label": "이메일",
  "splash.account.password-label": "비밀번호",
  "splash.account.signin-email": "로그인",
  "splash.account.signup-email": "계정 만들기",
  ...
  "lobby.consent-transcript": "또한 화상회의로 진행되는 세션의 서면 전사록과 오디오/영상 녹화본이 CaNaMED 연구를 위해 보관되고 분석되는 것에 동의합니다. 전사록은 화상회의 도구(Microsoft Teams)가 자동으로 생성하며, 제 발언마다 제 이름이 함께 기록됩니다. 전사록뿐만 아니라 세션 녹화본도 보관됩니다. 둘 다 공표 후 5년간, 나머지 연구 데이터세트와 동일한 제한된 접근 권한으로 보관되며, 저는 언제든지 삭제를 요청할 수 있습니다. 사진은 촬영되지 않으며, 카메라를 켤 의무도 없습니다. 이 세 번째 항목에 체크하지 않아도, 그리고 위의 연구 항목에 체크하지 않아도 워크숍에 참여할 수 있습니다 — 거부하더라도 참여, 성적, 대학에서의 지위에 아무런 영향이 없습니다.",
  "lobby.consent-version": "안내문 버전 PIS v11 · 2026-09. ",
  "lobby.consent-version-link": "개인정보 처리방침 전문",
  "lobby.consent-version-suffix": ".",
  "lobby.privacy.summary": "데이터 사용 방법 (참여 전에 읽어 주세요)",
  "lobby.privacy.controller-default": "CaNaMED 연구팀(<strong>Université de Caen Normandie × 나고야 대학</strong>, GDPR 제26조에 따른 공동관리자 / APPI 제27조(5)에 따른 공동이용자)",
  "lobby.privacy.controller-named": "<strong>{name}</strong>(이 세션의 개인정보 관리자)",
  "lobby.privacy.p1": "{controller}은 여러분의 이름 또는 닉네임, 대학, 학년, 자가 평가한 영어 수준을 수집합니다. 이름은 같은 방의 모든 참가자에게 표시되며 여러분이 기여한 점수 옆에 함께 나타납니다.",
  ...
  "lobby.privacy.p3": "데이터는 Google Firebase Realtime Database의 <strong>europe-west1(벨기에, EU)</strong>에 저장됩니다. 일본 참가자의 경우 이는 EU–일본 상호 적정성 결정(PPC, 2019)에 의해 보호되는 국경 간 이전입니다. 라이브 세션 데이터는 세션 종료 후 30일 이내에 삭제되며(세션이 종료되지 않은 경우 생성 후 90일 이내에 삭제됩니다), 연구 동의 항목에 체크하신 경우 기여 내용은 발표 후 최대 5년 동안 본인과 연결된(식별 가능한) 형태로 보관됩니다. 또한 사본은 야간 백업에 생성 후 최대 90일 동안 남아 있어, 세션의 마지막 사본은 종료 후 약 120일이 지나야 사라집니다. 백업은 장애 발생 후 서비스 복구에만 사용하며 데이터 조회에는 사용하지 않습니다.",
  "lobby.privacy.transcript": "세션은 소속 대학의 구독 계약에 따라 <strong>Microsoft Teams 화상회의</strong>로 진행되며, 이에 대해서는 Google과 함께 <strong>Microsoft</strong>가 수탁자로 관여합니다. 이 도구는 <strong>서면 전사록을 자동으로 생성</strong>하며, 전사록에는 발언마다 귀하의 이름이 함께 기록됩니다. 전사록뿐만 아니라 세션의 오디오/영상 녹화본도 보관됩니다. 전사록과 녹화본은 <strong>세 번째 동의 항목에 체크한 경우에만</strong> 공표 후 5년간, 나머지 연구 데이터세트와 동일한 제한된 접근 권한으로 보관되며, 언제든지 삭제를 요청할 수 있습니다. <strong>사진은 촬영되지 않으며, 카메라를 켤 의무도 없습니다.</strong>",
  ...
  "splash.create.sections-help": "오늘의 섹션(진행 순서). 도입과 마무리는 항상 포함됩니다.",
  "splash.create.sections-empty": "No sections yet — add at least one.",
  "splash.create.sections-add-label": "섹션 하나 추가",
  "splash.create.sections-add": "+ 섹션 하나 추가",
  "splash.create.case-label": "증례",
  "splash.create.case-help": "증례를 선택하고 오늘 진행할 부분에 체크한 뒤 추가하세요. 아래에서 순서를 바꾸거나 제거할 수 있고, 다른 증례의 부분을 섞을 수도 있습니다.",
  "splash.create.case-add": "+ 체크한 부분 추가",
  "splash.create.case-full": "{wanted}개 중 {added}개 추가됨 — 세션은 최대 {max}개 섹션까지입니다",
  "splash.create.sections-full": "세션이 가득 찼습니다 — 최대 {max}개 섹션",
  ...
  "stage.label.welcome": "환영합니다",
  "stage.label.wrapup": "마무리",
  "stage.label.section": "섹션 {n} — {title}",
  "stage.label.0": "환영합니다",
  "stage.label.4": "마무리",
