...
(function (root, factory) {
  ...
  "lobby.consent-version": "안내문 버전 PIS v8 · 2026-09. ",
  ...
  "lobby.privacy.p3": "데이터는 Google Firebase Realtime Database의 <strong>europe-west1(벨기에, EU)</strong>에 저장됩니다. 일본 참가자의 경우 이는 EU–일본 상호 적정성 결정(PPC, 2019)에 의해 보호되는 국경 간 이전입니다. 라이브 세션 데이터는 세션 종료 후 30일 이내에 삭제되며(세션이 종료되지 않은 경우 생성 후 90일 이내에 삭제됩니다), 연구 동의 항목에 체크하신 경우 기여 내용은 발표 후 최대 5년 동안 본인과 연결된(식별 가능한) 형태로 보관됩니다.",
