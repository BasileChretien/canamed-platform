...
(function (root, factory) {
  ...
  "modA.coach.open-discussion": "✓ 仮説が出ました — 「一緒に話し合う」を開きましょう。グループで症例と、フランスと日本の疼痛管理の違いについて話し合い、計画と主要な違いを記入してください。",  "modA.coach.bullets-partial": "回答を記録中 — あと{n}つ追加してください(計画＋フランス/日本の違い)。",
  "modA.coach.bullets-complete": "✓ 2つの回答が記録されました。さらに加筆するか、ファシリテーターをお待ちください。",  "modB.coach.pick-role": "まず状況を一緒に読み、それから下で役割に就いてください — 正解はありません。あとで役割を交代して再演します。",
