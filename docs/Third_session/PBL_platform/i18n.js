...
(function (root, factory) {
  ...
  const T = {
    en: {
      ...
      "rcol.tab.chat": "Side-chat",
      "rcol.chat.intro": "Private side-chat for your room — for clarifying questions, glossary checks, side-thoughts. Messages stay within this room only.",
      "rcol.chat.placeholder": "Type a quick message…",
      "rcol.chat.send": "Send",
    ...
    fr: {
      ...
      "lobby.forgot-pass-link": "Besoin de définir ou récupérer le mot de passe ? ›",
      "modA.bullet-progress.plan": "Plan",
      ...
      "rcol.tab.chat": "Tchat de salle",
      "rcol.chat.intro": "Tchat privé pour votre salle — questions de clarification, vocabulaire, pensées à part. Les messages restent dans cette salle.",
      "rcol.chat.placeholder": "Tapez un message rapide…",
      "rcol.chat.send": "Envoyer",
      ...
      "modB.coach.roleplay": "Rôles attribués ! Jouez la scène — la phase 2 est le jeu de rôle, la phase 3 est la discussion avec les questions ci-dessous. L'observateur·rice les lit à voix haute.",
      ...
      "tour.studentModA.1.body": "Ces quatre puces suivent les progrès de votre équipe sur les quatre questions. Cochez-les en écrivant les réponses.",
    ...
    ja: {
      ...
      "lobby.forgot-pass-link": "管理者パスワードを設定または再設定しますか？ ›",
      ...
      "rcol.tab.chat": "サイドチャット",
      "rcol.chat.intro": "ルーム内専用のチャット — 言葉の確認や補足など。メッセージはこのルーム内に留まります。",
      "rcol.chat.placeholder": "短いメッセージを入力…",
      "rcol.chat.send": "送信",
      ...
      "modB.coach.roleplay": "役割が決まりました! 場面を演じてください — フェーズ2はロールプレイ、フェーズ3は下の項目を使ったディスカッションです。観察者が声に出して読み上げます。",
      ...
      "tour.studentModA.1.body": "この4つのチップは、グループの回答4項目に対するチームの進捗を示します。回答を書きながらチェックされていきます。",
