...
var CASE = {
  ...
  prompts: [
    // Round-4 Rec 2: explicit differential prompt placed FIRST so the team
    // generates a hypothesis set before agreeing the synthesis (no code
    // references prompt indices — they render sequentially by cursor).
    { en: "Differential first, plan second: before you agree your synthesis, name THREE diagnoses you would seriously consider for an office worker with 8 months of low-back pain, and for each, the single history or examination feature that would push you toward it (e.g. mechanical/non-specific low-back pain, inflammatory back pain / axial spondyloarthritis, and a 'must-not-miss' such as malignancy, infection or cauda equina). Only then agree your synthesis.",
      fr: "Le diagnostic différentiel d'abord, le plan ensuite : avant de valider votre synthèse, nommez TROIS diagnostics que vous envisageriez sérieusement chez un employé de bureau souffrant de 8 mois de lombalgie, et pour chacun, le seul élément d'anamnèse ou d'examen qui vous y orienterait (p. ex. lombalgie mécanique / non spécifique, lombalgie inflammatoire / spondyloarthrite axiale, et un diagnostic « à ne pas manquer » tel que néoplasie, infection ou syndrome de la queue de cheval). Ce n'est qu'ensuite que vous validez votre synthèse.",
      ja: "まず鑑別、次に計画:総合判断を確定する前に、8か月の腰痛を訴えるオフィスワーカーについて真剣に考慮すべき診断を3つ挙げ、それぞれについて、その診断へ傾ける唯一の病歴または診察所見を述べてください(例:機械的/非特異的腰痛、炎症性腰痛/体軸性脊椎関節炎、そして悪性腫瘍・感染・馬尾症候群などの「見逃してはならない」診断)。そのうえで初めて総合判断を確定してください。" },
    { en: "Management plan: agree a first-line plan for chronic non-specific low-back pain - staying active and returning to the gym, education and reassurance, structured exercise / physiotherapy, non-opioid analgesia, and tackling fear of movement, sleep and mood. Name the single most important element - and, in plain words and without dismissing his very real pain, how you would tell Mr Lefebvre that more scans and strong opioids are not the answer.",
      fr: "Plan de prise en charge : élaborez un plan de première intention pour la lombalgie chronique non spécifique — maintien de l'activité et reprise du sport, éducation et réassurance, exercice / kinésithérapie structuré·e, antalgie non opioïde, et prise en charge de la peur du mouvement, du sommeil et du moral. Nommez l'élément le plus important — et, avec des mots simples et sans minimiser sa douleur bien réelle, comment vous expliqueriez à M. Lefebvre que d'autres examens et des opioïdes forts ne sont pas la solution.",
      ja: "治療計画:慢性非特異的腰痛に対する第一選択の計画を立てましょう — 活動性の維持とジムへの復帰、教育と安心の提供、構造化された運動療法/理学療法、非オピオイド鎮痛、運動恐怖・睡眠・気分への対応。最も重要な要素を一つ挙げ、さらに、彼の本当の痛みを否定せずに平易な言葉で、さらなる画像検査や強オピオイドが答えではないことを M. Lefebvre にどう伝えるかを述べてください。" },
    ...
    { en: "Take a position: one sentence each - name the single biggest difference between how France and Japan would handle Mr Lefebvre, and say whether you think one approach is better, or whether each simply fits its own health system. Then, as a group, name one thing you could not agree on - you will write it down next.",
      fr: "Prenez position : une phrase chacun·e — nommez la principale différence entre la prise en charge de M. Lefebvre en France et au Japon, et dites si l'une des approches est, selon vous, meilleure, ou si chacune correspond simplement à son propre système de santé. Puis, en groupe, nommez une chose sur laquelle vous n'avez pas pu vous mettre d'accord — vous l'écrirez ensuite.",
      ja: "立場を表明:各自一文ずつ — フランスと日本で M. Lefebvre の対応における最大の違いを一つ挙げ、いずれかのアプローチがより優れていると思うか、あるいはそれぞれが自国の医療制度に適しているだけかを述べてください。そのうえでグループとして、合意できなかったことを一つ挙げてください — 次にそれを書き留めます。" }
  ]
};
...
var CASE_B = {
  history: [
    ...
    { group: { en: "Talking about the diagnosis with patient & family", fr: "Parler du diagnostic avec la patiente et la famille", ja: "患者・家族と診断について話す" },
  ...
  exam: [
    { group: { en: "Physical examination", fr: "Examen physique", ja: "身体診察" },
    ...
    { group: { en: "Capacity & decision-making", fr: "Capacité et prise de décision", ja: "判断能力と意思決定" },
  ...
  labs: [
    { q: { en: "Clinical synthesis and disclosure planning  (unlocks the discussion prompts)",
      ...
      key: true,
      a: { en: "You are looking at painless obstructive jaundice in an elderly woman with weight loss, anorexia, pale stools, dark urine, a palpable non-tender gallbladder (Courvoisier's sign) and an epigastric ache radiating to the back. CT abdomen confirms a mass in the head of the pancreas with liver metastases and peritoneal deposits — Stage IV pancreatic adenocarcinoma. Median survival with metastatic disease is measured in months. Mrs Tanaka has full decision-making capacity and has told you, in her own words, that she wants to know — gently, at her pace, with her son in the room. Her son, recently bereaved, has asked you not to tell her. Safety-net before she leaves: cholangitis precautions — return immediately for fever, rigors, worsening jaundice or right-upper-quadrant pain, because an obstructed biliary system can become infected and ascending cholangitis (jaundice + fever/rigors = Charcot's triad) is a medical emergency until biliary drainage (ERCP stent) is achieved; also warn about bleeding/bruising given the INR of 1.4. Before opening the prompts, decide as a group: who is in the room when you break the news, what you say in the first sentence, and how you reconcile the son's fear with the patient's stated preference. Then work through the prompts below.",
           fr: "Vous êtes face à un ictère obstructif indolore chez une femme âgée, avec perte de poids, anorexie, selles décolorées, urines foncées, vésicule palpable indolore (signe de Courvoisier) et douleur épigastrique irradiant dans le dos. Le scanner abdominal confirme une masse de la tête du pancréas avec métastases hépatiques et carcinose péritonéale — adénocarcinome pancréatique Stade IV. La survie médiane en cas de maladie métastatique se compte en mois. Madame Tanaka a une pleine capacité de décision et vous a dit, avec ses propres mots, qu'elle souhaitait savoir — doucement, à son rythme, avec son fils dans la pièce. Son fils, récemment endeuillé, vous a demandé de ne pas lui dire. Filet de sécurité avant qu'elle ne parte : précautions d'angiocholite — reconsulter immédiatement en cas de fièvre, frissons solennels, aggravation de l'ictère ou douleur de l'hypochondre droit, car un système biliaire obstrué peut s'infecter et l'angiocholite ascendante (ictère + fièvre/frissons = triade de Charcot) est une urgence médicale tant que le drainage biliaire (prothèse par CPRE) n'est pas réalisé ; prévenir aussi du risque de saignement/ecchymoses compte tenu de l'INR à 1,4. Avant d'ouvrir les questions de discussion, décidez en groupe : qui est dans la pièce au moment de l'annonce, ce que vous dites dans la première phrase, et comment vous conciliez la peur du fils avec la préférence exprimée par la patiente. Puis traitez les questions ci-dessous.",
           ja: "高齢女性の無痛性閉塞性黄疸であり、体重減少、食欲不振、灰白色便、濃染尿、圧痛のない触知可能な胆嚢 (Courvoisier徴候)、背部に放散する心窩部痛を呈しています。腹部CTで膵頭部腫瘤、肝転移、腹膜播種を確認 — Stage IV 膵腺がんです。転移性疾患の生存期間中央値は数か月単位で測られます。田中さんは完全な意思決定能力を有し、自分の言葉で「優しく、自分のペースで、息子に同席してもらって」知りたいと述べました。最近父親を亡くした息子は、母親に伝えないでほしいと頼んでいます。退室前のセーフティネット:胆管炎の注意 — 発熱、悪寒戦慄、黄疸の悪化、右上腹部痛があれば直ちに再診すること。閉塞した胆道系は感染しうるため、上行性胆管炎(黄疸+発熱/悪寒戦慄=Charcot三徴)は胆道ドレナージ(ERCPステント)が達成されるまで救急疾患です。またINR 1.4 を踏まえ出血・皮下出血についても注意を促します。ディスカッション課題を開く前に、グループで決めましょう:告知の場に誰が同席するか、最初の一文に何と言うか、そして息子の恐れと患者が表明した希望をどう調和させるか。その後、下記の課題に取り組んでください。" } },
  ...
  prompts: [
    // Round-4 Rec 2: explicit differential prompt placed FIRST. Even in a case
    // whose teaching focus is disclosure, the team should reason from the
    // presentation (painless obstructive jaundice) before being handed the
    // diagnosis by the synthesis.
    { en: "Differential first, plan second: before you reach the disclosure conversation, name THREE diagnoses you would seriously consider for an elderly woman with painless obstructive jaundice and weight loss, and for each, the single history, examination or investigation feature that would push you toward it (e.g. pancreatic head / distal biliary malignancy — Courvoisier's sign and the double-duct CT; choledocholithiasis — colicky pain and the absence of weight loss; cholangiocarcinoma or another periampullary tumour — the imaging pattern). Only then agree your synthesis.",
      fr: "Le diagnostic différentiel d'abord, le plan ensuite : avant d'aborder l'annonce, nommez TROIS diagnostics que vous envisageriez sérieusement chez une femme âgée présentant un ictère obstructif indolore avec perte de poids, et pour chacun, le seul élément d'anamnèse, d'examen ou d'imagerie qui vous y orienterait (p. ex. néoplasie de la tête du pancréas / des voies biliaires distales — signe de Courvoisier et « double canal » au scanner ; lithiase cholédocienne — douleur colique et absence de perte de poids ; cholangiocarcinome ou autre tumeur péri-ampullaire — l'aspect en imagerie). Ce n'est qu'ensuite que vous validez votre synthèse.",
      ja: "まず鑑別、次に計画:告知の会話に入る前に、無痛性の閉塞性黄疸と体重減少を呈する高齢女性について真剣に考慮すべき診断を3つ挙げ、それぞれについて、その診断へ傾ける唯一の病歴・診察・検査所見を述べてください(例:膵頭部/遠位胆管の悪性腫瘍 — Courvoisier徴候とCTの「double duct」サイン;総胆管結石 — 疝痛様の痛みと体重減少がないこと;胆管がんやその他の乳頭部周囲腫瘍 — 画像所見のパターン)。そのうえで初めて総合判断を確定してください。" },
    ...
    { en: "Take a position: one sentence each — name the single biggest difference between how France and Japan would handle this conversation, and say whether you think one approach is better, or whether each simply fits its own health system and culture. Then, as a group, name one thing you could not agree on — you will write it down next.",
      fr: "Prenez position : une phrase chacun·e — nommez la principale différence entre la façon dont la France et le Japon mèneraient cette conversation, et dites si l'une des approches est, selon vous, meilleure, ou si chacune correspond simplement à son propre système de santé et à sa culture. Puis, en groupe, nommez une chose sur laquelle vous n'avez pas pu vous mettre d'accord — vous l'écrirez ensuite.",
      ja: "立場を表明:各自一文ずつ — フランスと日本でこの会話の進め方の最大の違いを一つ挙げ、いずれかのアプローチがより優れていると思うか、あるいはそれぞれが自国の医療制度と文化に適しているだけかを述べてください。そのうえでグループとして、合意できなかったことを一つ挙げてください — 次にそれを書き留めます。" }
  ]
};
...
var DECISIONS_B = [
  ...
  {
    id: "dec_stage_first", module: "A", points: 25, penalty: 15,
    unlockWhen: { hypotheses: 1, historyRevealed: 1, examRevealed: 1 },
    prompt: { en: "The ultrasound shows a dilated biliary tree and a suspicious mass in the pancreatic head. Bilirubin 245 µmol/L, ALP 720 U/L. She is itching badly but is not septic. What does your team order next?",
              fr: "L'échographie montre une dilatation des voies biliaires et une masse suspecte de la tête du pancréas. Bilirubine 245 µmol/L, PAL 720 UI/L. Elle a un prurit important mais n'est pas septique. Que prescrit votre équipe ?",
              ja: "超音波で胆管拡張と膵頭部の疑わしい腫瘤を認めます。ビリルビン245 µmol/L、ALP 720 U/L。掻痒は強いものの敗血症はありません。チームは次に何をオーダーしますか?" },
    options: [
      { text: { en: "Pancreatic-protocol contrast CT for staging, BEFORE any biliary intervention",
                fr: "Un scanner injecté en protocole pancréatique pour le bilan d'extension, AVANT tout geste biliaire",
                ja: "胆道への処置の前に、病期診断のための膵プロトコル造影CT" },
        correct: true,
        why: { en: "Image before you instrument. The pancreas-protocol CT is the study that establishes stage — tumour extent, vascular involvement, distant disease — and a stent placed first introduces inflammatory change and artefact that degrade exactly that assessment, on top of the pancreatitis risk of ERCP. Note where it leads for Mrs Tanaka: the CT is what reveals the encased superior mesenteric vessels, and with the biopsy it establishes unresectable Stage IV disease. Getting that answer EARLY is what makes the later decision about stenting for symptom relief a considered one rather than a default.",
             fr: "Imager avant d'instrumenter. Le scanner en protocole pancréatique est l'examen qui établit le stade — extension tumorale, atteinte vasculaire, maladie à distance — et une prothèse posée d'abord induit des remaniements inflammatoires et des artefacts qui dégradent précisément cette évaluation, en sus du risque de pancréatite de la CPRE. Voyez où cela mène chez Mme Tanaka : c'est le scanner qui montre l'engainement des vaisseaux mésentériques supérieurs et qui, avec la biopsie, établit une maladie de stade IV non résécable. Obtenir cette réponse TÔT est ce qui fait de la décision ultérieure de prothèse à visée symptomatique un choix réfléchi et non un réflexe.",
             ja: "処置の前に画像を。膵プロトコルCTは病期 — 腫瘍の広がり、血管浸潤、遠隔転移 — を定める検査であり、先にステントを置けば炎症性変化とアーチファクトがまさにその評価を損ないます。ERCP自体の膵炎リスクも加わります。田中さんの場合に引き付けて考えれば、上腸間膜動脈の巻き込みを明らかにするのがこのCTであり、生検と合わせて切除不能のStage IVを確定させます。その答えを早く得ることが、後の症状緩和目的のステント留置の判断を、惰性ではなく熟考されたものにします。" } },
      { text: { en: "ERCP with stenting now, to relieve the jaundice",
                fr: "Une CPRE avec prothèse maintenant, pour lever l'ictère",
                ja: "黄疸を軽減するため、直ちにERCPとステント留置" },
        correct: false,
        why: { en: "Tempting, because she is uncomfortable and the bilirubin is high. But she is not septic and not in renal failure, so this is not urgent drainage — and doing it first degrades the staging CT.",
             fr: "Tentant, car elle est inconfortable et la bilirubine est élevée. Mais elle n'est ni septique ni en insuffisance rénale : ce n'est pas un drainage urgent — et le faire d'abord dégrade le scanner de bilan.",
             ja: "不快感が強くビリルビンも高いため魅力的に見えます。しかし敗血症も腎不全もなく、緊急ドレナージの適応ではありません。先行させると病期診断CTの質を落とします。" } },
      { text: { en: "Refer straight to oncology without further imaging",
                fr: "Adresser directement en oncologie sans imagerie complémentaire",
                ja: "追加の画像検査なしに直接腫瘍内科へ紹介" },
        correct: false,
        why: { en: "No tissue, no stage, no resectability assessment — oncology cannot plan from this, and it lengthens rather than shortens the pathway.",
             fr: "Sans histologie, sans stade, sans évaluation de la résécabilité, l'oncologie ne peut rien planifier : cela allonge le parcours au lieu de le raccourcir.",
             ja: "組織診も病期も切除可能性の評価もなければ腫瘍内科は計画を立てられず、経路を短縮するどころか長引かせます。" } }
    ]
  },
  {
    id: "dec_who_decides", module: "A", points: 25, penalty: 0,
    unlockWhen: { hypotheses: 1 },
    prompt: { en: "Her adult son asks the team, privately, not to tell his mother. Before you go back in, what does your team agree?",
              fr: "Son fils adulte demande discrètement à l'équipe de ne rien dire à sa mère. Avant de retourner la voir, sur quoi votre équipe s'accorde-t-elle ?",
              ja: "成人した息子が、母親には伝えないでほしいとチームに個別に頼んできました。病室に戻る前に、チームは何を合意しますか?" },
    options: [
      { text: { en: "Establish what SHE wants to know first, then honour it",
                fr: "Établir d'abord ce qu'ELLE souhaite savoir, puis le respecter",
                ja: "まず本人が何を知りたいかを確認し、それを尊重する" },
        correct: true,
        why: { en: "Capacity is intact, so the decision is hers — including the right not to know. Asking her what she wants is not the same as telling her everything, and it takes the family out of the position of gatekeeper without making them the adversary.",
             fr: "Sa capacité est conservée : la décision lui appartient, y compris le droit de ne pas savoir. Lui demander ce qu'elle souhaite n'équivaut pas à tout lui dire, et cela retire à la famille le rôle de filtre sans en faire un adversaire.",
             ja: "判断能力は保たれており、知らないでいる権利も含めて決定は本人のものです。何を望むか尋ねることは全てを告げることとは異なり、家族を情報の門番の立場から外しつつ、敵対させずに済みます。" } },
      { text: { en: "Agree with the son and defer the conversation",
                fr: "Accepter la demande du fils et différer la conversation",
                ja: "息子の意向に沿い、話し合いを先送りする" },
        correct: false,
        why: { en: "It buys calm now at the cost of her autonomy, and it commits the team to something it cannot keep once she asks a direct question.",
             fr: "Cela achète du calme immédiat au prix de son autonomie, et engage l'équipe sur une promesse intenable dès qu'elle posera une question directe.",
             ja: "今の平穏を自律性と引き換えに得るものであり、本人が直接尋ねた瞬間に守れなくなる約束をチームに負わせます。" } },
      { text: { en: "Tell her the full diagnosis immediately, as the law requires",
                fr: "Lui annoncer immédiatement le diagnostic complet, comme la loi l'exige",
                ja: "法が求めるとおり、直ちに診断のすべてを伝える" },
        correct: false,
        why: { en: "Direct information is the default, but \"immediately and in full\" ignores the Invitation step — the obligation is to offer the information, not to impose it.",
             fr: "L'information directe est la règle, mais « immédiatement et en totalité » ignore l'étape de l'invitation : l'obligation est de proposer l'information, non de l'imposer.",
             ja: "直接の情報提供が原則ですが、「直ちに全て」はInvitationの段階を無視しています。義務は情報を提供することであり、押しつけることではありません。" } }
    ]
  }
];
...
var CASE_C = {
  history: [
    { group: { en: "Presenting complaint & red-flag screen", fr: "Motif de consultation et dépistage des drapeaux rouges", ja: "主訴とレッドフラッグのスクリーニング" },
    ...
    { group: { en: "Ideas, concerns & the antibiotic request", fr: "Idées, préoccupations et la demande d'antibiotique", ja: "考え・心配ごとと抗菌薬の要望" },
    ...
    { group: { en: "Background & social history", fr: "Antécédents et mode de vie", ja: "既往歴と生活背景" },
  ...
  exam: [
    ...
    { group: { en: "Focused ENT & neck examination", fr: "Examen ORL et cervical ciblé", ja: "焦点を絞った耳鼻咽喉・頸部の診察" },
    ...
    { group: { en: "Risk scoring", fr: "Score de risque", ja: "リスクスコアの算出" },
      q: { en: "Score the McIsaac/Centor criteria for her",
           fr: "Calculer son score McIsaac/Centor",
           ja: "McIsaac/Centorスコアを算出する" },
      a: { en: "Centor / McIsaac points: history of fever > 38°C — NO (max 37.8°C, currently 37.4°C); absence of cough — NO (she has a cough); tender anterior cervical lymphadenopathy — NO; tonsillar swelling/exudate — N/A (post-tonsillectomy); age 3-14 / 15-44 / ≥ 45 — age 32, score 0. TOTAL Centor 0, McIsaac 0. Probability of group A streptococcal infection is very low (~ 1-2.5%). Guidelines (HAS 2021, NICE NG84, CDC) DO NOT recommend antibiotics or even a rapid antigen test at this score — the clinical picture is viral pharyngitis. A teaching caveat: a post-tonsillectomy patient cannot be fully Centor/McIsaac-scored — the tonsillar criterion is permanently unavailable, so the score is applied with caution and the clinician leans harder on the remaining criteria and the overall picture, not on a mechanical total. This is a real example of applying a clinical score outside its validation population.",
           fr: "Points Centor / McIsaac : antécédent de fièvre > 38°C — NON (max 37,8°C, actuellement 37,4°C) ; absence de toux — NON (elle tousse) ; adénopathie cervicale antérieure douloureuse — NON ; hypertrophie/exsudat amygdalien — N/A (post-amygdalectomie) ; âge 3-14 / 15-44 / ≥ 45 — âge 32, score 0. TOTAL Centor 0, McIsaac 0. La probabilité d'une infection à streptocoque du groupe A est très faible (~ 1-2,5%). Les recommandations (HAS 2021, NICE NG84, CDC) ne recommandent NI antibiotique NI test antigénique rapide à ce score — le tableau clinique est celui d'une pharyngite virale. Mise en garde pédagogique : un patient amygdalectomisé ne peut pas être entièrement scoré par Centor/McIsaac — le critère amygdalien est définitivement indisponible, de sorte que le score s'applique avec prudence et que le clinicien s'appuie davantage sur les autres critères et le tableau global, et non sur un total mécanique. C'est un véritable exemple d'application d'un score clinique en dehors de sa population de validation.",
           ja: "Centor / McIsaacの各項目:38°C超の発熱の既往 — なし(最高37.8°C、現在37.4°C);咳がない — 該当せず(咳あり);圧痛を伴う前頸部リンパ節腫脹 — なし;扁桃腫脹/滲出液 — 評価不能(扁桃摘出後);年齢 3-14 / 15-44 / ≥ 45 — 32歳でスコア0。合計 Centor 0、McIsaac 0。A群溶連菌感染症の確率は非常に低い(約1-2.5%)。各ガイドライン(HAS 2021、NICE NG84、CDC)はこのスコアでは抗生物質も迅速抗原検査も推奨していません — 臨床像はウイルス性咽頭炎です。教育上の注意点:扁桃摘出後の患者は Centor/McIsaac で完全にスコアリングすることはできません — 扁桃の項目は恒久的に評価不能であるため、スコアは慎重に適用し、機械的な合計点ではなく残りの項目と全体像により重きを置きます。これは臨床スコアをその検証対象集団の外で適用する実際の例です。" } },
  ...
  prompts: [
    // Round-4 Rec 2: explicit differential prompt placed FIRST. It also names
    // the actual 2026 respiratory viruses, reinforcing the currency point in
    // the synthesis (labs[0]) below.
    { en: "Differential first, plan second: before you agree your synthesis, name THREE diagnoses you would seriously consider for an adult with 5 days of sore throat, and for each, the single feature that separates it — viral pharyngitis (cough, coryza, hoarseness; in 2026 most often SARS-CoV-2, influenza A/B, RSV or the rhinovirus/adenovirus family) vs group A streptococcal pharyngitis (fever > 38°C, absent cough, tender anterior nodes, exudate — i.e. a higher Centor/McIsaac) vs a must-not-miss such as EBV infectious mononucleosis (posterior nodes, splenomegaly, marked fatigue) or early peritonsillar abscess / Lemierre (unilateral severe pain, trismus, 'hot-potato' voice). Only then agree your synthesis.",
      fr: "Le diagnostic différentiel d'abord, le plan ensuite : avant de valider votre synthèse, nommez TROIS diagnostics que vous envisageriez sérieusement chez une adulte présentant 5 jours de mal de gorge, et pour chacun, le seul élément qui le distingue — pharyngite virale (toux, rhinorrhée, enrouement ; en 2026 le plus souvent SARS-CoV-2, grippe A/B, VRS ou la famille rhinovirus/adénovirus) vs pharyngite à streptocoque du groupe A (fièvre > 38°C, absence de toux, adénopathies antérieures douloureuses, exsudat — soit un score de Centor/McIsaac plus élevé) vs un diagnostic « à ne pas manquer » tel que mononucléose infectieuse à EBV (ganglions postérieurs, splénomégalie, fatigue marquée) ou abcès péri-amygdalien débutant / Lemierre (douleur unilatérale sévère, trismus, voix « patate chaude »). Ce n'est qu'ensuite que vous validez votre synthèse.",
      ja: "まず鑑別、次に計画:総合判断を確定する前に、5日間の咽頭痛を訴える成人について真剣に考慮すべき診断を3つ挙げ、それぞれについて区別する唯一の所見を述べてください — ウイルス性咽頭炎(咳、鼻汁、嗄声;2026年では多くが SARS-CoV-2、インフルエンザA/B、RSV、またはライノウイルス/アデノウイルスの仲間)vs A群溶連菌性咽頭炎(38°C超の発熱、咳がない、圧痛を伴う前頸部リンパ節、滲出 — すなわち高いCentor/McIsaacスコア)vs 見逃してはならない診断、たとえばEBV伝染性単核球症(後頸部リンパ節、脾腫、強い倦怠感)や初期の扁桃周囲膿瘍/Lemierre(片側性の強い痛み、開口障害、「熱いポテト」声)。そのうえで初めて総合判断を確定してください。" },
    { en: "Symptomatic plan: she needs to fly to Frankfurt on Friday and wants amoxicillin. Build a symptomatic plan that addresses the trip directly — analgesia, voice rest, in-flight hydration, when to use an NSAID vs paracetamol, and what to do if it gets worse the morning of the flight — and, without sounding like you're refusing her care, how you would explain in two or three plain sentences that an antibiotic will not get her to Frankfurt. The single most important sentence to her about the trip is…?",
      fr: "Plan symptomatique : elle doit prendre l'avion pour Francfort vendredi et réclame de l'amoxicilline. Construisez un plan symptomatique qui aborde directement le voyage — antalgie, repos de la voix, hydratation en vol, quand utiliser un AINS plutôt que le paracétamol, et conduite à tenir si cela s'aggrave le matin du vol — et, sans donner l'impression de refuser de la soigner, comment vous expliqueriez en deux ou trois phrases simples qu'un antibiotique ne l'aidera pas à se rendre à Francfort. La phrase la plus importante à lui dire à propos du voyage est… ?",
      ja: "対症療法プラン:彼女は金曜にフランクフルトへ飛ぶ必要があり、アモキシシリンを求めています。出張を直接取り上げる対症療法プラン(鎮痛、声の安静、機内の水分摂取、NSAIDとアセトアミノフェンの使い分け、フライト当日の朝に悪化した場合の対応)を立て、さらに、ケアを拒否しているように聞こえないように、抗生物質ではフランクフルトに行けるようにはならないことを2~3文の平易な言葉でどう説明するかを述べてください。出張について彼女に伝えるべき最も重要な一文は何ですか?" },
    { en: "Compare France & Japan — antibiotics & stewardship: France has one of the OECD's highest per-capita antibiotic consumption rates, with a long-standing expectation in some patients that a sore throat warrants amoxicillin; Japan's MHLW AMR National Action Plan and the 2018 抗微生物薬適正使用加算 (Antimicrobial Stewardship Premium) actually reimburse a clinician for NOT prescribing. Caen and Nagoya: in a Friday-morning consultation, what does the patient expect — and would paying a doctor not to prescribe, or a delayed 'back-pocket' prescription (fill only if worse over 48-72h), work in your country? Name one real difference, then debate whether such a financial nudge is sound stewardship or just off-loading the decision.",
      fr: "Comparaison France-Japon — antibiotiques et bon usage : la France a l'une des consommations d'antibiotiques par habitant les plus élevées de l'OCDE, avec une attente ancrée chez certains patients qu'un mal de gorge mérite de l'amoxicilline ; le Plan national antibiorésistance du MHLW japonais et le 抗微生物薬適正使用加算 (« forfait bon usage des antimicrobiens », 2018) rémunèrent au contraire le médecin qui NE prescrit PAS. Caen et Nagoya : un vendredi matin, qu'attend la patiente — et est-ce que payer un médecin pour ne pas prescrire, ou une prescription différée (« de réserve », à n'utiliser qu'en cas d'aggravation à 48-72 h), fonctionnerait dans votre pays ? Nommez une vraie différence, puis débattez : ce signal financier est-il un bon usage solide ou un simple transfert de la décision ?",
      ja: "フランスと日本の比較 — 抗生物質と適正使用:フランスは一人当たりの抗生物質消費量がOECDで最も高い水準の一つで、一部の患者には「のどが痛ければアモキシシリン」という根強い期待があります;一方、日本のMHLWによるAMR対策国家行動計画と2018年の「抗微生物薬適正使用加算」は、むしろ処方しない医師に報酬を与えます。Caen と名古屋:金曜の午前の診察で患者は何を期待しますか — そして、処方しないことへの報酬や、遅延処方(「とっておき処方」、48-72時間で悪化した場合のみ使用)は、あなたの国で機能するでしょうか?実際の違いを一つ挙げ、こうした経済的な誘導が健全な適正使用なのか、それとも単なる判断の押し付けなのかを議論してください。" },
    ...
    { en: "Take a position: one sentence each — name the single biggest difference between how a French and a Japanese primary-care clinician would handle Mme Moreau in 2026, and say whether you think one approach is better, or whether each is simply the rational response to its own health system's incentives and patient expectations. Then, as a group, name one thing you could not agree on — you will write it down next.",
      fr: "Prenez position : une phrase chacun·e — nommez la principale différence entre la façon dont un médecin généraliste français et un médecin de soins primaires japonais prendraient en charge Mme Moreau en 2026, et dites si l'une des approches est, selon vous, meilleure, ou si chacune n'est que la réponse rationnelle aux incitatifs et aux attentes des patients de son propre système de santé. Puis, en groupe, nommez une chose sur laquelle vous n'avez pas pu vous mettre d'accord — vous l'écrirez ensuite.",
      ja: "立場を表明:各自一文ずつ — 2026年にフランスの一般医と日本のプライマリ・ケア医が Mme Moreau をどう対応するかの最大の違いを一つ挙げ、いずれかのアプローチがより優れていると思うか、あるいはそれぞれが自国の医療制度のインセンティブと患者の期待に対する合理的な応答にすぎないかを述べてください。そのうえでグループとして、合意できなかったことを一つ挙げてください — 次にそれを書き留めます。" }
  ]
};
...
var DECISIONS_C = [
  ...
  {
    id: "dec_commit", module: "B", points: 25, penalty: 0,
    prompt: { en: "She asks a second time, more firmly, for amoxicillin. What does your group commit to?",
              fr: "Elle redemande de l'amoxicilline, plus fermement. Sur quoi votre groupe s'engage-t-il ?",
              ja: "彼女は二度目、より強い調子でアモキシシリンを求めます。あなたのグループは何を約束しますか?" },
    options: [
      { text: { en: "No antibiotic, an explicit symptomatic plan, and clear return advice",
                fr: "Pas d'antibiotique, un plan symptomatique explicite et des consignes de reconsultation claires",
                ja: "抗菌薬は出さず、明確な対症療法の計画と再受診の目安を示す" },
        correct: true,
        why: { en: "Centor/McIsaac 0 with cough and coryza is viral. The defensible position is not \"no\" — it is \"no, here is why, here is what will actually help, and here is when to come back\".",
             fr: "Un score de Centor/McIsaac à 0 avec toux et rhinorrhée est viral. La position défendable n'est pas « non », mais « non, voici pourquoi, voici ce qui va réellement aider, et voici quand revenir ».",
             ja: "咳と鼻汁を伴うCentor/McIsaac 0はウイルス性です。擁護できる立場は「ノー」ではなく、「ノー、理由はこうで、実際に役立つのはこれで、こういう時に戻ってきてください」です。" } },
      { text: { en: "Prescribe amoxicillin — she has a deadline and it keeps the relationship",
                fr: "Prescrire l'amoxicilline — elle a une échéance et cela préserve la relation",
                ja: "アモキシシリンを処方する — 締め切りがあり、関係も保てる" },
        correct: false,
        why: { en: "It ends the consultation faster and costs the patient the most: no benefit at this score, a rash if this turns out to be EBV, and the next sore throat starts from \"last time I got antibiotics\".",
             fr: "Cela abrège la consultation et coûte le plus à la patiente : aucun bénéfice à ce score, un rash si c'est une MNI, et le prochain mal de gorge partira de « la dernière fois, on m'a donné des antibiotiques ».",
             ja: "診察は早く終わりますが、患者の負担は最大です。このスコアでは利益がなく、EBVであれば皮疹を生じ、次回の咽頭痛は「前回は抗菌薬をもらった」から始まります。" } },
      { text: { en: "Give a delayed prescription without explaining it",
                fr: "Remettre une ordonnance différée sans l'expliquer",
                ja: "説明せずに遅延処方箋を渡す" },
        correct: false,
        why: { en: "Delayed prescribing works when it is framed as a safety net. Handed over silently it reads as \"the doctor thinks I'll need it\", and it is filled the same day.",
             fr: "La prescription différée fonctionne lorsqu'elle est présentée comme un filet de sécurité. Remise sans un mot, elle se lit « le médecin pense que j'en aurai besoin » — et elle est délivrée le jour même.",
             ja: "遅延処方はセーフティネットとして説明されて初めて機能します。黙って渡せば「医師も必要だと思っている」と読まれ、その日のうちに調剤されます。" } }
    ]
  },
  {
    id: "dec_friday", module: "B", points: 25, penalty: 0,
    prompt: { en: "What does your group do with the Friday presentation she keeps mentioning?",
              fr: "Que fait votre groupe de la présentation de vendredi qu'elle ne cesse d'évoquer ?",
              ja: "彼女が繰り返し口にする金曜日のプレゼンを、グループはどう扱いますか?" },
    options: [
      { text: { en: "Treat it as the real problem and plan around it",
                fr: "La traiter comme le vrai problème et bâtir le plan autour",
                ja: "それを本当の課題として扱い、計画をそこに合わせる" },
        correct: true,
        why: { en: "Regular analgesia, fluids, voice care and realistic expectations for Friday address what she actually came for. Naming the deadline as legitimate is what makes the refusal land as care rather than obstruction.",
             fr: "Antalgiques réguliers, hydratation, ménagement de la voix et attentes réalistes pour vendredi répondent à ce pour quoi elle est venue. Reconnaître l'échéance comme légitime est ce qui fait recevoir le refus comme un soin et non comme un obstacle.",
             ja: "定期的な鎮痛、水分、声の安静、金曜日への現実的な見通しこそが、彼女が本当に求めて来た内容に応えます。締め切りを正当なものとして認めることが、拒否をケアとして受け取らせます。" } },
      { text: { en: "Tell her work is not a medical indication",
                fr: "Lui répondre que le travail n'est pas une indication médicale",
                ja: "仕事は医学的適応ではないと伝える" },
        correct: false,
        why: { en: "True, and useless. It answers a question she did not ask and confirms that you were not listening.",
             fr: "Exact, et inutile. Cela répond à une question qu'elle n'a pas posée et confirme qu'on ne l'écoutait pas.",
             ja: "正しいけれども役に立ちません。尋ねられていない問いに答えており、話を聞いていなかったことを裏づけます。" } },
      { text: { en: "Offer a sick note instead",
                fr: "Proposer un arrêt de travail à la place",
                ja: "代わりに診断書(休職)を提案する" },
        correct: false,
        why: { en: "A reasonable option to have available, but offered instead of a plan it substitutes your priority for hers.",
             fr: "Option raisonnable à garder en réserve, mais proposée à la place d'un plan, elle substitue votre priorité à la sienne.",
             ja: "選択肢として持っておくのは妥当ですが、計画の代わりに提示すると、患者の優先事項をこちらの優先事項に置き換えてしまいます。" } }
    ]
  }
];
...
var PRETEST_CHRONIC_PAIN = [
  ...
  { id: "q6",
    q: { en: "How is CHRONIC low-back pain defined by duration?",
         fr: "Comment la lombalgie CHRONIQUE est-elle définie selon sa durée ?",
         ja: "慢性腰痛は持続期間によってどのように定義されますか?" },
    options: [
      { text: { en: "Pain persisting for 12 weeks (3 months) or more",
                fr: "Une douleur persistant 12 semaines (3 mois) ou plus",
                ja: "12週間(3か月)以上持続する痛み" }, correct: true },
      { text: { en: "Pain lasting more than 1 week",
                fr: "Une douleur durant plus d'une semaine",
                ja: "1週間以上続く痛み" }, correct: false },
      { text: { en: "Any pain that requires painkillers",
                fr: "Toute douleur nécessitant des antalgiques",
                ja: "鎮痛薬を必要とするあらゆる痛み" }, correct: false },
      { text: { en: "Pain that recurs more than twice in a lifetime",
                fr: "Une douleur récidivant plus de deux fois dans une vie",
                ja: "生涯で2回を超えて再発する痛み" }, correct: false }
    ],
    explanation: { en: "Chronic low-back pain is defined as pain persisting for 12 weeks (3 months) or more. By convention, pain under 6 weeks is acute and 6–12 weeks is subacute.",
                   fr: "La lombalgie chronique se définit comme une douleur persistant 12 semaines (3 mois) ou plus. Par convention, une douleur de moins de 6 semaines est aiguë, et de 6 à 12 semaines subaiguë.",
                   ja: "慢性腰痛は12週間(3か月)以上持続する痛みと定義されます。慣例上、6週間未満は急性、6〜12週間は亜急性とされます。" } },
  { id: "q7",
    q: { en: "What is the recommended FIRST-LINE, non-pharmacological approach for chronic non-specific low-back pain?",
         fr: "Quelle est l'approche non pharmacologique de PREMIÈRE INTENTION recommandée dans la lombalgie chronique non spécifique ?",
         ja: "慢性非特異的腰痛における推奨される第一選択の非薬物療法はどれですか?" },
    options: [
      { text: { en: "Strict bed rest until the pain is gone",
                fr: "Repos au lit strict jusqu'à disparition de la douleur",
                ja: "痛みが消えるまでの厳格な安静臥床" }, correct: false },
      { text: { en: "A long-term rigid lumbar brace",
                fr: "Un corset lombaire rigide au long cours",
                ja: "長期間の硬性腰椎装具" }, correct: false },
      { text: { en: "Staying active plus a structured exercise programme of a type the patient will sustain",
                fr: "Rester actif et un programme d'exercice structuré d'un type que le patient maintiendra",
                ja: "活動性の維持と、患者が継続できる種類の構造化された運動プログラム" }, correct: true },
      { text: { en: "Early spinal fusion surgery",
                fr: "Une arthrodèse vertébrale précoce",
                ja: "早期の脊椎固定術" }, correct: false }
    ],
    explanation: { en: "NICE NG59 recommends staying active and a structured exercise programme (any form the patient will sustain) plus self-management as first-line. Bed rest is harmful and prolongs disability.",
                   fr: "NICE NG59 recommande en première intention de rester actif et un programme d'exercice structuré (toute forme que le patient maintiendra), associés à l'autogestion. Le repos au lit est délétère et prolonge l'incapacité.",
                   ja: "NICE NG59は、自己管理と併せて、活動性の維持と構造化された運動プログラム(患者が継続できる形式なら何でも)を第一選択として推奨しています。安静臥床は有害であり、能力障害を長引かせます。" } },
  { id: "q8",
    q: { en: "Per NICE NG59, what is the role of paracetamol (acetaminophen) ALONE in chronic non-specific low-back pain?",
         fr: "Selon NICE NG59, quel est le rôle du paracétamol SEUL dans la lombalgie chronique non spécifique ?",
         ja: "NICE NG59によれば、慢性非特異的腰痛におけるアセトアミノフェン単独の役割はどれですか?" },
    options: [
      { text: { en: "It is the first-line drug at maximum dose",
                fr: "C'est le médicament de première intention à dose maximale",
                ja: "最大用量での第一選択薬である" }, correct: false },
      { text: { en: "It is NOT recommended as a stand-alone treatment for low-back pain",
                fr: "Il n'est PAS recommandé comme traitement isolé de la lombalgie",
                ja: "腰痛の単独治療としては推奨されない" }, correct: true },
      { text: { en: "It is more effective than NSAIDs",
                fr: "Il est plus efficace que les AINS",
                ja: "NSAIDsより効果的である" }, correct: false },
      { text: { en: "It must always be tried before NSAIDs",
                fr: "Il doit toujours être essayé avant les AINS",
                ja: "常にNSAIDsより先に試みなければならない" }, correct: false }
    ],
    explanation: { en: "NICE NG59 advises against paracetamol monotherapy for low-back pain; it is not recommended as a stand-alone treatment. NSAIDs at the lowest effective dose are the first-line pharmacology, alongside exercise.",
                   fr: "NICE NG59 déconseille la monothérapie par paracétamol dans la lombalgie ; il n'est pas recommandé comme traitement isolé. Les AINS à la plus faible dose efficace constituent la pharmacothérapie de première intention, associés à l'exercice.",
                   ja: "NICE NG59は腰痛に対するアセトアミノフェン単剤療法を推奨していません — 単独治療としては推奨されません。運動と併せた最低有効用量のNSAIDsが第一選択の薬物療法です。" } },
  { id: "q9",
    q: { en: "A patient avoids all activity because they fear movement will cause damage (fear-avoidance / kinesiophobia). The best management is:",
         fr: "Un patient évite toute activité car il craint que le mouvement ne cause des lésions (évitement par peur / kinésiophobie). La meilleure prise en charge est :",
         ja: "ある患者は、動くと損傷が生じると恐れてあらゆる活動を回避しています(恐怖回避/キネシオフォビア)。最善の管理は:" },
    options: [
      { text: { en: "Advise rest until the pain has fully resolved",
                fr: "Conseiller le repos jusqu'à disparition complète de la douleur",
                ja: "痛みが完全に消失するまで安静を勧める" }, correct: false },
      { text: { en: "Reassure that movement is safe, educate that hurt does not equal harm, and use graded return to activity",
                fr: "Rassurer que le mouvement est sûr, expliquer que douleur ne signifie pas lésion, et utiliser une reprise graduée de l'activité",
                ja: "運動は安全だと安心させ、「痛み≠損傷」であると教育し、段階的な活動復帰を用いる" }, correct: true },
      { text: { en: "Prescribe a back brace to limit movement",
                fr: "Prescrire un corset pour limiter le mouvement",
                ja: "運動を制限するため腰部装具を処方する" }, correct: false },
      { text: { en: "Start a strong opioid so they can rest comfortably",
                fr: "Débuter un opioïde fort pour qu'il puisse se reposer confortablement",
                ja: "快適に休めるよう強オピオイドを開始する" }, correct: false }
    ],
    explanation: { en: "Graded activity/exposure combined with pain education reduces fear-avoidance and disability. Reassuring that movement is safe — that hurt does not equal harm — is the core message, in line with NICE NG59 and HAS.",
                   fr: "L'activité/exposition graduée associée à l'éducation à la douleur réduit l'évitement par peur et l'incapacité. Rassurer que le mouvement est sûr — que douleur ne signifie pas lésion — est le message central, conforme à NICE NG59 et à la HAS.",
                   ja: "段階的な活動・曝露と疼痛教育の併用は、恐怖回避と能力障害を減らします。運動は安全である — 「痛み≠損傷」である — と安心させることが中心的なメッセージであり、NICE NG59やHASと一致します。" } },
  { id: "q10",
    q: { en: "What is the natural history of most episodes of non-specific low-back pain — and why does it matter clinically?",
         fr: "Quelle est l'évolution naturelle de la plupart des épisodes de lombalgie non spécifique — et pourquoi est-ce cliniquement important ?",
         ja: "非特異的腰痛のほとんどのエピソードの自然経過はどうなりますか — そしてそれはなぜ臨床的に重要ですか?" },
    options: [
      { text: { en: "It inevitably progresses to permanent disability",
                fr: "Elle évolue inévitablement vers une incapacité permanente",
                ja: "必然的に永続的な能力障害へと進行する" }, correct: false },
      { text: { en: "The prognosis is generally favourable and most episodes improve; explaining this is itself therapeutic",
                fr: "Le pronostic est généralement favorable et la plupart des épisodes s'améliorent ; l'expliquer est en soi thérapeutique",
                ja: "予後は概ね良好で大半のエピソードは改善する;これを説明すること自体が治療的である" }, correct: true },
      { text: { en: "It almost always signals serious spinal pathology",
                fr: "Elle signale presque toujours une pathologie rachidienne grave",
                ja: "ほとんど常に重篤な脊椎病変を示唆する" }, correct: false },
      { text: { en: "It will eventually require surgery",
                fr: "Elle finira par nécessiter une chirurgie",
                ja: "最終的に手術を必要とする" }, correct: false }
    ],
    explanation: { en: "Most episodes of non-specific low-back pain have a favourable natural history and improve over time. Explaining this favourable prognosis is itself a key reassurance/education message that supports active management (NICE NG59, HAS, JOA 2019).",
                   fr: "La plupart des épisodes de lombalgie non spécifique ont une évolution naturelle favorable et s'améliorent avec le temps. Expliquer ce pronostic favorable est en soi un message clé de réassurance/éducation qui soutient la prise en charge active (NICE NG59, HAS, JOA 2019).",
                   ja: "非特異的腰痛のほとんどのエピソードは自然経過が良好で、時間とともに改善します。この良好な予後を説明すること自体が、能動的管理を支える重要な安心・教育のメッセージです(NICE NG59、HAS、JOA 2019)。" } },
  {
    id: "q11",
    q: { en: "Bad news is not only a diagnosis. You have decided NOT to prescribe the opioid Mr Lefebvre came for. Which opening best serves the rest of the consultation?",
         fr: "Une mauvaise nouvelle n'est pas seulement un diagnostic. Vous avez décidé de NE PAS prescrire l'opioïde que M. Lefebvre est venu chercher. Quelle ouverture sert le mieux la suite de la consultation ?",
         ja: "悪い知らせは診断だけではありません。ルフェーブルさんが求めて来たオピオイドを処方しないと決めました。この後の診察に最も資する切り出し方はどれですか?" },
    options: [
      { text: { en: "Name what you understand he was hoping for, then say plainly that you will not prescribe it — and why — before moving to what you will do",
                fr: "Nommer ce qu'il espérait, puis dire clairement que vous ne le prescrirez pas — et pourquoi — avant de passer à ce que vous ferez",
                ja: "彼が何を期待していたかを言葉にし、処方しないこととその理由を明確に述べたうえで、では何をするのかに進む" }, correct: true },
      { text: { en: "Begin with the list of things you can offer, and mention the refusal only if he raises it again",
                fr: "Commencer par la liste de ce que vous pouvez proposer, et n'évoquer le refus que s'il y revient",
                ja: "提供できることの一覧から始め、彼が再び持ち出した場合にのみ断りに触れる" }, correct: false },
      { text: { en: "Explain the pharmacology of opioid tolerance and hyperalgesia in full before saying anything about his request",
                fr: "Expliquer en détail la pharmacologie de la tolérance et de l'hyperalgésie aux opioïdes avant d'aborder sa demande",
                ja: "彼の要望に触れる前に、オピオイド耐性と痛覚過敏の薬理を詳しく説明する" }, correct: false },
      { text: { en: "Tell him the guidelines do not allow it, so the decision is out of your hands",
                fr: "Lui dire que les recommandations ne le permettent pas et que la décision ne vous appartient donc pas",
                ja: "ガイドラインが認めていないので自分の裁量ではない、と伝える" }, correct: false }
    ],
    explanation: { en: "The same structure that carries a diagnosis carries a refusal: acknowledge the expectation, deliver the unwelcome part clearly and early, give the reason, then spend the rest of the consultation on the plan. Burying the refusal makes the patient discover it late and re-open the fight; hiding behind \"the guidelines\" removes you as the person he can negotiate the plan with (NICE NG59; CDC 2022 opioid guideline, which is explicit that a decision not to prescribe must come with a plan, not a dismissal).",
                   fr: "La structure qui porte un diagnostic porte aussi un refus : reconnaître l'attente, énoncer clairement et tôt la part difficile, en donner la raison, puis consacrer le reste de la consultation au plan. Enfouir le refus fait que le patient le découvre tard et rouvre le conflit ; se réfugier derrière « les recommandations » vous retire comme interlocuteur avec qui négocier le plan (NICE NG59 ; recommandation opioïdes CDC 2022, explicite sur le fait qu'un refus doit s'accompagner d'un plan et non d'un renvoi).",
                   ja: "診断を伝える構造は、断りを伝える構造でもあります。期待を認め、受け入れにくい部分を早く明確に述べ、理由を示し、残りの時間を計画に充てます。断りを埋もれさせれば患者は後から気づいて争点が再燃し、「ガイドラインが」と後ろに隠れれば、計画を一緒に決められる相手としてのあなたが消えます(NICE NG59、CDC 2022年オピオイド指針 — 処方しない判断には計画を伴わせるべきと明記)。" } },
  {
    id: "q12",
    q: { en: "What is a \"warning shot\" in a difficult conversation, and what is it for?",
         fr: "Qu'est-ce qu'un « tir de semonce » (warning shot) dans une conversation difficile, et à quoi sert-il ?",
         ja: "難しい会話における「ウォーニング・ショット(予告)」とは何で、何のためのものですか?" },
    options: [
      { text: { en: "A short phrase signalling that difficult news is coming, given a beat before the news itself, so the patient can brace",
                fr: "Une phrase brève signalant qu'une nouvelle difficile arrive, donnée un instant avant la nouvelle, pour que le patient puisse s'y préparer",
                ja: "難しい話が来ることを示す短い一言を、知らせの直前に置き、患者が心の準備をできるようにするもの" }, correct: true },
      { text: { en: "A statement of the worst possible outcome, so that anything else sounds better by comparison",
                fr: "L'énoncé du pire scénario possible, afin que tout le reste paraisse meilleur par comparaison",
                ja: "最悪の結果をまず述べ、他のすべてが相対的に良く聞こえるようにするもの" }, correct: false },
      { text: { en: "A warning to the family that they must not interrupt",
                fr: "Un avertissement à la famille lui demandant de ne pas interrompre",
                ja: "家族に対し、口を挟まないよう求める警告" }, correct: false },
      { text: { en: "A note in the record that bad news was delivered, for medico-legal protection",
                fr: "Une note dans le dossier attestant que la mauvaise nouvelle a été annoncée, à des fins médico-légales",
                ja: "悪い知らせを伝えたことを医療法務上の保護のためカルテに記す注記" }, correct: false }
    ],
    explanation: { en: "\"I'm afraid the results are not what we hoped\" — then a pause. The purpose is purely to close the gap between the patient's expectation and what is about to be said, so the news does not arrive as ambush. It belongs between the Perception and Knowledge steps of SPIKES, and it is as useful for a refused request as for a diagnosis.",
                   fr: "« Je crains que les résultats ne soient pas ceux que nous espérions » — puis une pause. Le but est uniquement de réduire l'écart entre l'attente du patient et ce qui va être dit, pour que la nouvelle n'arrive pas comme une embuscade. Cela se place entre les étapes Perception et Knowledge de SPIKES, et sert autant pour un refus que pour un diagnostic.",
                   ja: "「残念ながら、結果は期待していたものとは異なります」— そして一拍おく。目的は、患者の予期とこれから告げる内容との差を縮め、不意打ちにしないことに尽きます。SPIKESのPerceptionとKnowledgeの間に位置し、診断だけでなく要望を断る場面でも同じように役立ちます。" } },
  {
    id: "q13",
    q: { en: "A difficult consultation is nearly over. What does closing it WELL actually require (the 'S' — Strategy & Summary — of SPIKES)?",
         fr: "Une consultation difficile touche à sa fin. Que suppose réellement une BONNE clôture (le « S » — Strategy & Summary — de SPIKES) ?",
         ja: "難しい診察が終わりに近づいています。よい締めくくりに実際に必要なのは何ですか(SPIKESの「S」— Strategy & Summary)?" },
    options: [
      { text: { en: "A concrete next step with a named time frame, a check of what the patient took away, and how to reach you if things change",
                fr: "Une étape suivante concrète avec une échéance nommée, une vérification de ce que le patient a retenu, et comment vous joindre si les choses changent",
                ja: "期日を明示した具体的な次の一歩、患者が何を持ち帰ったかの確認、状況が変わったときの連絡方法" }, correct: true },
      { text: { en: "A full repetition of everything said, so nothing is forgotten",
                fr: "Une répétition intégrale de tout ce qui a été dit, pour que rien ne soit oublié",
                ja: "言ったことをすべて繰り返し、忘れが生じないようにすること" }, correct: false },
      { text: { en: "An assurance that everything will probably be fine",
                fr: "L'assurance que tout ira probablement bien",
                ja: "おそらく大丈夫だろうという保証" }, correct: false },
      { text: { en: "Leaving the plan open, since the patient is too distressed to decide anything today",
                fr: "Laisser le plan ouvert, puisque le patient est trop bouleversé pour décider quoi que ce soit aujourd'hui",
                ja: "患者は動揺していて何も決められないので、計画は開いたままにしておくこと" }, correct: false }
    ],
    explanation: { en: "Distress is exactly why the close must be concrete: recall after bad news is poor, so a plan that exists only in the clinician's head does not exist. A named next step, a teach-back check and an explicit safety net are what convert the conversation into care. Reassurance without a plan, or a plan deferred because the patient is upset, both leave the patient to manage alone.",
                   fr: "La détresse est précisément la raison pour laquelle la clôture doit être concrète : la mémorisation après une mauvaise nouvelle est faible, donc un plan qui n'existe que dans la tête du soignant n'existe pas. Une étape suivante nommée, une vérification par reformulation et un filet de sécurité explicite transforment la conversation en soin. Une réassurance sans plan, ou un plan différé parce que le patient est bouleversé, laissent l'un comme l'autre le patient seul.",
                   ja: "動揺しているからこそ、締めくくりは具体的でなければなりません。悪い知らせの後の記憶保持は乏しく、医療者の頭の中にしかない計画は存在しないのと同じです。名指しされた次の一歩、ティーチバックによる確認、明示的なセーフティネットが、会話をケアに変えます。計画のない安心づけも、動揺を理由に先送りされた計画も、結局は患者を一人にします。" } }
];
...
var POSTTEST_CHRONIC_PAIN = [
  ...
  { id: "q6",
    q: { en: "What does current evidence say about LONG-TERM opioids for chronic non-cancer low-back pain?",
         fr: "Que disent les données actuelles sur les opioïdes au LONG COURS dans la lombalgie chronique non cancéreuse ?",
         ja: "慢性非がん性腰痛に対する長期オピオイドについて、現行のエビデンスは何と述べていますか?" },
    options: [
      { text: { en: "Strong evidence of durable benefit",
                fr: "Des preuves solides d'un bénéfice durable",
                ja: "持続的な有益性の確固たるエビデンスがある" }, correct: false },
      { text: { en: "Little evidence of sustained benefit, with clear harms — dependence, tolerance, opioid-induced hyperalgesia and overdose risk",
                fr: "Peu de preuves d'un bénéfice durable, avec des méfaits clairs — dépendance, tolérance, hyperalgésie induite par les opioïdes et risque de surdose",
                ja: "持続的な有益性のエビデンスはほとんどなく、明らかな害がある — 依存、耐性、オピオイド誘発性痛覚過敏、過量服用リスク" }, correct: true },
      { text: { en: "Safe indefinitely at a low dose",
                fr: "Sûrs indéfiniment à faible dose",
                ja: "低用量であれば無期限に安全である" }, correct: false },
      { text: { en: "Recommended first-line by NICE and the CDC",
                fr: "Recommandés en première intention par NICE et le CDC",
                ja: "NICEおよびCDCが第一選択として推奨している" }, correct: false }
    ],
    explanation: { en: "There is little evidence of sustained benefit from long-term opioids in chronic non-cancer pain, against clear harms: dependence, tolerance, opioid-induced hyperalgesia and overdose risk. CDC 2022 and NICE NG59 do not recommend opioids for routine chronic non-cancer pain.",
                   fr: "Il existe peu de preuves d'un bénéfice durable des opioïdes au long cours dans la douleur chronique non cancéreuse, face à des méfaits clairs : dépendance, tolérance, hyperalgésie induite par les opioïdes et risque de surdose. Le CDC 2022 et NICE NG59 ne recommandent pas les opioïdes dans la douleur chronique non cancéreuse courante.",
                   ja: "慢性非がん性疼痛における長期オピオイドの持続的な有益性のエビデンスはほとんどなく、依存・耐性・オピオイド誘発性痛覚過敏・過量服用リスクという明らかな害があります。CDC 2022およびNICE NG59は、通常の慢性非がん性疼痛にオピオイドを推奨していません。" } },
  { id: "q7",
    q: { en: "At a routine review of chronic non-specific low-back pain with NO new red flags, what is the role of repeat imaging?",
         fr: "Lors d'un suivi de routine d'une lombalgie chronique non spécifique SANS nouveau drapeau rouge, quel est le rôle de l'imagerie répétée ?",
         ja: "新たなレッドフラッグのない慢性非特異的腰痛の定期診察において、画像の再検査の役割はどれですか?" },
    options: [
      { text: { en: "An annual MRI should be scheduled to monitor the discs",
                fr: "Une IRM annuelle devrait être programmée pour surveiller les disques",
                ja: "椎間板を監視するため年1回のMRIを予定すべきである" }, correct: false },
      { text: { en: "CT is the preferred follow-up investigation",
                fr: "Le scanner est l'examen de suivi à privilégier",
                ja: "CTが望ましいフォローアップ検査である" }, correct: false },
      { text: { en: "Repeat imaging is not indicated and can cause harm (incidental findings driving worry and more tests)",
                fr: "L'imagerie répétée n'est pas indiquée et peut être délétère (trouvailles fortuites générant inquiétude et examens supplémentaires)",
                ja: "画像の再検査は適応がなく、害となりうる(偶発所見が不安と追加検査を招く)" }, correct: true },
      { text: { en: "Image before every review to reassure the patient",
                fr: "Imager avant chaque consultation pour rassurer le patient",
                ja: "患者を安心させるため毎回の診察前に画像を撮る" }, correct: false }
    ],
    explanation: { en: "Without new red flags, repeat imaging in chronic non-specific low-back pain is low-value and can cause harm: incidental age-related findings drive worry, further tests and disability. NICE NG59, HAS and JOA 2019 all advise against it.",
                   fr: "En l'absence de nouveau drapeau rouge, l'imagerie répétée dans la lombalgie chronique non spécifique est de faible valeur et peut être délétère : les trouvailles fortuites liées à l'âge génèrent inquiétude, examens supplémentaires et incapacité. NICE NG59, la HAS et la JOA 2019 la déconseillent.",
                   ja: "新たなレッドフラッグがなければ、慢性非特異的腰痛における画像の再検査は低価値で、害となりえます:加齢に伴う偶発所見が不安・追加検査・能力障害を招きます。NICE NG59、HAS、JOA 2019はいずれもこれを推奨していません。" } },
  { id: "q8",
    q: { en: "A patient has prominent yellow flags (low mood, catastrophising, fear-avoidance). Which ADDED intervention is most effective?",
         fr: "Un patient présente des drapeaux jaunes marqués (humeur basse, catastrophisation, évitement par peur). Quelle intervention AJOUTÉE est la plus efficace ?",
         ja: "ある患者に顕著なイエローフラッグ(抑うつ気分、破局的思考、恐怖回避)があります。追加する介入として最も効果的なのはどれですか?" },
    options: [
      { text: { en: "Escalate to strong opioids",
                fr: "Passer aux opioïdes forts",
                ja: "強オピオイドへ増強する" }, correct: false },
      { text: { en: "Immobilise the spine",
                fr: "Immobiliser le rachis",
                ja: "脊椎を固定する" }, correct: false },
      { text: { en: "Order repeat imaging",
                fr: "Prescrire une imagerie répétée",
                ja: "画像の再検査を指示する" }, correct: false },
      { text: { en: "A psychologically-informed approach — CBT-informed care and pain education — alongside exercise",
                fr: "Une approche psychologiquement informée — soins inspirés des TCC et éducation à la douleur — associée à l'exercice",
                ja: "心理学的に裏打ちされたアプローチ — 認知行動療法に基づくケアと疼痛教育 — を運動と併せて行う" }, correct: true }
    ],
    explanation: { en: "Yellow flags (low mood, catastrophising, fear-avoidance) are the target of a psychologically-informed approach: CBT-informed care and pain education alongside exercise. Opioids, immobilisation and repeat imaging do not address the psychosocial drivers and may worsen chronicity (NICE NG59).",
                   fr: "Les drapeaux jaunes (humeur basse, catastrophisation, évitement par peur) sont la cible d'une approche psychologiquement informée : soins inspirés des TCC et éducation à la douleur, associés à l'exercice. Les opioïdes, l'immobilisation et l'imagerie répétée ne traitent pas les facteurs psychosociaux et peuvent aggraver la chronicité (NICE NG59).",
                   ja: "イエローフラッグ(抑うつ気分、破局的思考、恐怖回避)は、心理学的に裏打ちされたアプローチの標的です:認知行動療法に基づくケアと疼痛教育を運動と併せて行います。オピオイド、固定、画像の再検査は心理社会的要因に対処せず、慢性化を悪化させうます(NICE NG59)。" } },
  { id: "q9",
    q: { en: "A patient fears they are being 'under-treated because of rules'. How is a non-opioid plan best framed?",
         fr: "Un patient craint d'être « sous-traité à cause des règles ». Comment cadrer au mieux un plan sans opioïde ?",
         ja: "ある患者は「規則のせいで過少治療されている」と恐れています。非オピオイドの計画を最もよく枠づける方法は?" },
    options: [
      { text: { en: "Tell them the rules simply forbid opioids",
                fr: "Lui dire que les règles interdisent tout simplement les opioïdes",
                ja: "規則がオピオイドを禁じているだけだと伝える" }, correct: false },
      { text: { en: "As actively treating and protecting them (active rehabilitation, education) — not as withholding",
                fr: "Comme un traitement actif qui le protège (rééducation active, éducation) — non comme une privation",
                ja: "(能動的リハビリ、教育による)積極的な治療かつ保護として — 差し控えとしてではなく" }, correct: true },
      { text: { en: "Give a small opioid to keep them on side",
                fr: "Donner un petit opioïde pour le garder de son côté",
                ja: "味方につけておくため少量のオピオイドを渡す" }, correct: false },
      { text: { en: "Refer them elsewhere to avoid the conflict",
                fr: "L'adresser ailleurs pour éviter le conflit",
                ja: "対立を避けるため他へ紹介する" }, correct: false }
    ],
    explanation: { en: "Framing the plan as actively treating and protecting the patient (active rehabilitation, education) rather than as withholding a drug preserves the therapeutic alliance and adherence. CDC 2022 and HAS stress shared decision-making, not a blunt appeal to rules.",
                   fr: "Cadrer le plan comme un traitement actif qui protège le patient (rééducation active, éducation) plutôt que comme la privation d'un médicament préserve l'alliance thérapeutique et l'observance. Le CDC 2022 et la HAS insistent sur la décision partagée, et non sur un renvoi brutal aux règles.",
                   ja: "計画を、薬の差し控えではなく、患者を積極的に治療し保護するもの(能動的リハビリ、教育)として枠づけることが、治療同盟とアドヒアランスを保ちます。CDC 2022とHASは、規則への一方的な訴えではなく共有意思決定を強調しています。" } },
  { id: "q10",
    q: { en: "Which outcome best reflects successful management of chronic low-back pain?",
         fr: "Quel résultat reflète le mieux une prise en charge réussie de la lombalgie chronique ?",
         ja: "慢性腰痛の管理が成功したことを最もよく反映する成果はどれですか?" },
    options: [
      { text: { en: "Complete elimination of all pain",
                fr: "La disparition complète de toute douleur",
                ja: "あらゆる痛みの完全な消失" }, correct: false },
      { text: { en: "A normal MRI",
                fr: "Une IRM normale",
                ja: "正常なMRI" }, correct: false },
      { text: { en: "Improved function and return to meaningful activity, even if some pain remains",
                fr: "Une fonction améliorée et un retour à une activité qui a du sens, même s'il persiste une certaine douleur",
                ja: "たとえ多少の痛みが残っても、機能の改善と意味のある活動への復帰" }, correct: true },
      { text: { en: "The number of analgesics prescribed",
                fr: "Le nombre d'antalgiques prescrits",
                ja: "処方された鎮痛薬の数" }, correct: false }
    ],
    explanation: { en: "Successful management is measured by improved function and return to meaningful activity, even if some pain remains — not by a pain score of zero, a normal scan, or the number of analgesics. Function-focused goals are central to NICE NG59, HAS and JOA 2019.",
                   fr: "Une prise en charge réussie se mesure à l'amélioration de la fonction et au retour à une activité qui a du sens, même s'il persiste une certaine douleur — non à un score de douleur nul, une imagerie normale ou le nombre d'antalgiques. Les objectifs centrés sur la fonction sont au cœur de NICE NG59, de la HAS et de la JOA 2019.",
                   ja: "管理の成功は、たとえ多少の痛みが残っても、機能の改善と意味のある活動への復帰によって測られます — 痛みのスコアがゼロであること、画像が正常であること、鎮痛薬の数によってではありません。機能に焦点を当てた目標が、NICE NG59、HAS、JOA 2019の中心です。" } }
];
...
var PRETEST_BREAKING_BAD_NEWS = [
  { id: "q1",
    ...
    explanation: { en: "A patient who can understand, retain, weigh and communicate has decision-making capacity, so in law the information is hers — capacity, not age, family hierarchy or a 'best-interests' override, determines who controls disclosure. This is the default in law and guidance in France (Loi Kouchner 2002) and in current Japanese MHLW guidance. In practice, however, the family's role in the disclosure process remains more prominent by default in Japan than in France — but that practice cannot override a competent patient's expressed wish.",
                   fr: "Une patiente capable de comprendre, retenir, pondérer et communiquer a la capacité de décider, donc en droit l'information lui appartient — c'est la capacité, non l'âge, la hiérarchie familiale ou un principe de « bien du patient », qui détermine qui contrôle l'annonce. C'est la règle, en droit et dans les recommandations, en France (Loi Kouchner 2002) et dans les recommandations actuelles du MHLW japonais. En pratique, toutefois, le rôle de la famille dans le processus d'annonce reste plus présent par défaut au Japon qu'en France — mais cette pratique ne peut pas l'emporter sur le souhait exprimé d'une patiente apte.",
                   ja: "理解・保持・比較考量・伝達ができる患者には意思決定能力があり、法的には情報は本人のものです — 誰が告知をコントロールするかを決めるのは、年齢でも家族の序列でも「最善の利益」原則でもなく、能力です。これは法律および指針のうえで、フランス(Loi Kouchner 2002)でも現行の日本のMHLWガイダンスでも原則です。ただし実務では、告知のプロセスにおける家族の役割は、フランスよりも日本のほうが既定としてより前面に出ます — とはいえ、その実務が判断能力のある患者本人の表明した希望を覆すことはできません。" } },
  { id: "q2",
...
,
  ...
  { id: "q7",
    q: { en: "In the SPIKES protocol, what does the 'S' (Setting) step involve?",
         fr: "Dans le protocole SPIKES, en quoi consiste l'étape « S » (Setting/cadre) ?",
         ja: "SPIKESプロトコルにおいて、「S」(Setting/場の設定)のステップは何を含みますか?" },
    options: [
      { text: { en: "Stating the diagnosis in the first sentence",
                fr: "Énoncer le diagnostic dès la première phrase",
                ja: "最初の一文で診断を述べること" }, correct: false },
      { text: { en: "Arranging a private, uninterrupted setting, sitting down, allowing enough time, and arranging an interpreter if needed",
                fr: "Aménager un cadre privé et sans interruption, s'asseoir, prévoir assez de temps, et organiser un interprète si nécessaire",
                ja: "中断のないプライベートな場を整え、着席し、十分な時間を確保し、必要なら通訳を手配すること" }, correct: true },
      { text: { en: "Inviting all available staff to attend",
                fr: "Inviter tout le personnel disponible à assister",
                ja: "対応可能なスタッフ全員に同席を求めること" }, correct: false },
      { text: { en: "Remaining standing to keep the meeting short",
                fr: "Rester debout pour écourter l'entretien",
                ja: "面談を短く保つため立ったままでいること" }, correct: false }
    ],
    explanation: { en: "The Setting step of SPIKES means preparing the environment and yourself before disclosure: a private, uninterrupted space, sitting down, enough time, and an interpreter if needed. It sets the conditions for an empathic, patient-led conversation.",
                   fr: "L'étape Setting de SPIKES consiste à préparer l'environnement et soi-même avant l'annonce : un espace privé et sans interruption, s'asseoir, du temps suffisant, et un interprète si nécessaire. Elle pose les conditions d'un entretien empathique et centré sur le patient.",
                   ja: "SPIKESのSettingのステップは、告知の前に環境と自分自身を整えることを意味します:中断のないプライベートな空間、着席、十分な時間、必要なら通訳です。共感的で患者主導の対話の条件を整えます。" } },
  { id: "q8",
    q: { en: "During SPIKES, the patient becomes tearful as you give the news. The best response (the 'E', Empathy, step) is to:",
         fr: "Pendant SPIKES, la patiente fond en larmes au moment de l'annonce. La meilleure réponse (l'étape « E », Empathie) est de :",
         ja: "SPIKESの最中、告知をする際に患者が涙ぐみます。最善の応答(「E」、Empathy/共感のステップ)は:" },
    options: [
      { text: { en: "Continue immediately with the treatment details",
                fr: "Poursuivre immédiatement avec les détails du traitement",
                ja: "ただちに治療の詳細へ進むこと" }, correct: false },
      { text: { en: "Reassure falsely that everything will be fine",
                fr: "Rassurer faussement que tout ira bien",
                ja: "すべてうまくいくと偽りの安心を与えること" }, correct: false },
      { text: { en: "Acknowledge the emotion, pause and allow silence before giving any more information",
                fr: "Reconnaître l'émotion, faire une pause et laisser le silence avant de donner d'autres informations",
                ja: "感情を受け止め、それ以上の情報を与える前に間を取り沈黙を許すこと" }, correct: true },
      { text: { en: "Step out to give privacy and end the consultation",
                fr: "Sortir pour laisser de l'intimité et mettre fin à l'entretien",
                ja: "プライバシーのため退室し面談を終えること" }, correct: false }
    ],
    explanation: { en: "The Empathy step calls for an empathic, NURSE-style response: name and acknowledge the emotion, then pause and tolerate silence before adding information. False reassurance and ploughing on with details both fail the patient.",
                   fr: "L'étape Empathie appelle une réponse empathique de type NURSE : nommer et reconnaître l'émotion, puis faire une pause et tolérer le silence avant d'ajouter des informations. La fausse réassurance et l'enchaînement des détails desservent la patiente.",
                   ja: "Empathyのステップは、NURSE型の共感的な応答を求めます:感情を名づけて受け止め、その上で間を取り、情報を加える前に沈黙を許容します。偽りの安心や詳細を畳みかけることは、いずれも患者のためになりません。" } },
  { id: "q9",
    q: { en: "A competent patient says she does NOT want to know the details of her diagnosis. Under French law (Loi Kouchner) the correct action is:",
         fr: "Une patiente apte dit qu'elle ne veut PAS connaître les détails de son diagnostic. Selon le droit français (Loi Kouchner), la bonne conduite est :",
         ja: "判断能力のある患者が、自分の診断の詳細を知りたくないと言います。フランスの法律(Loi Kouchner)のもとで正しい対応は:" },
    options: [
      { text: { en: "She must be told everything regardless",
                fr: "Elle doit tout savoir quoi qu'il arrive",
                ja: "いずれにせよ本人にすべてを伝えなければならない" }, correct: false },
      { text: { en: "Respect her right not to know, while keeping the door open for later",
                fr: "Respecter son droit de ne pas savoir, tout en laissant la porte ouverte pour plus tard",
                ja: "後で知る余地を残しつつ、知らない権利を尊重する" }, correct: true },
      { text: { en: "Tell the family the details instead",
                fr: "Annoncer plutôt les détails à la famille",
                ja: "代わりに家族に詳細を伝える" }, correct: false },
      { text: { en: "Declare that she lacks capacity",
                fr: "Déclarer qu'elle est inapte",
                ja: "本人に意思決定能力がないと判断する" }, correct: false }
    ],
    explanation: { en: "The Loi Kouchner (2002) enshrines both the right to be informed AND the right not to know. A competent patient's wish not to know must be respected, while keeping the door open should she change her mind. Bypassing her to the family or declaring incapacity is not justified.",
                   fr: "La Loi Kouchner (2002) consacre à la fois le droit d'être informé ET le droit de ne pas savoir. Le souhait d'une patiente apte de ne pas savoir doit être respecté, tout en laissant la porte ouverte si elle change d'avis. La contourner vers la famille ou la déclarer inapte n'est pas justifié.",
                   ja: "Loi Kouchner(2002)は、知らされる権利と知らない権利の双方を定めています。判断能力のある患者の「知りたくない」という希望は尊重されなければならず、気が変わった場合に備えて余地を残します。本人を素通りして家族に伝えたり、能力がないと判断したりすることは正当化されません。" } },
  { id: "q10",
    q: { en: "In SPIKES, why ask 'What have you understood so far?' (the 'P', Perception, step) before disclosing?",
         fr: "Dans SPIKES, pourquoi demander « Qu'avez-vous compris jusqu'ici ? » (l'étape « P », Perception) avant d'annoncer ?",
         ja: "SPIKESにおいて、告知の前に「ここまで何を理解されていますか?」(「P」、Perception/認識のステップ)と尋ねるのはなぜですか?" },
    options: [
      { text: { en: "To test the patient's memory",
                fr: "Pour tester la mémoire du patient",
                ja: "患者の記憶を試すため" }, correct: false },
      { text: { en: "To delay giving the news",
                fr: "Pour retarder l'annonce",
                ja: "告知を先延ばしにするため" }, correct: false },
      { text: { en: "To assess the patient's current understanding before giving information — 'before you tell, ask'",
                fr: "Pour évaluer ce que le patient comprend déjà avant de donner l'information — « avant de dire, demander »",
                ja: "情報を与える前に患者の現在の理解を評価するため — 「伝える前に尋ねる」" }, correct: true },
      { text: { en: "To shift the conversation to the family",
                fr: "Pour déplacer la conversation vers la famille",
                ja: "会話を家族へ移すため" }, correct: false }
    ],
    explanation: { en: "The Perception step ('before you tell, ask') assesses what the patient already knows and believes, so the disclosure can be calibrated to that starting point. It is not a memory test, a delaying tactic, or a way to redirect to the family.",
                   fr: "L'étape Perception (« avant de dire, demander ») évalue ce que le patient sait et croit déjà, afin de calibrer l'annonce sur ce point de départ. Ce n'est ni un test de mémoire, ni une manœuvre dilatoire, ni un moyen de se tourner vers la famille.",
                   ja: "Perceptionのステップ(「伝える前に尋ねる」)は、患者がすでに何を知り、何を信じているかを評価し、その出発点に合わせて告知を調整するためのものです。記憶のテストでも、引き延ばしの策でも、家族へ向け直す手段でもありません。" } },
  { id: "q11",
    q: { en: "A 75-year-old presents with painless jaundice and a palpable, non-tender gallbladder. What does this combination suggest?",
         fr: "Une patiente de 75 ans présente un ictère indolore et une vésicule biliaire palpable et non douloureuse. Que suggère cette association ?",
         ja: "75歳の患者が無痛性黄疸と、圧痛のない触知可能な胆嚢を呈しています。この組み合わせは何を示唆しますか?" },
    options: [
      { text: { en: "A distal biliary obstruction more likely malignant than stone-related",
                fr: "Une obstruction biliaire distale, plus probablement maligne que lithiasique",
                ja: "遠位胆道閉塞であり、結石性よりも悪性の可能性が高い" }, correct: true },
      { text: { en: "Acute cholecystitis",
                fr: "Une cholécystite aiguë",
                ja: "急性胆嚢炎" } },
      { text: { en: "Gilbert syndrome",
                fr: "Un syndrome de Gilbert",
                ja: "ジルベール症候群" } },
      { text: { en: "Haemolysis",
                fr: "Une hémolyse",
                ja: "溶血" } }
    ],
    explanation: { en: "Courvoisier's sign: in gallstone disease the gallbladder is usually fibrotic and non-distensible, so a palpable painless gallbladder points away from stones and towards malignant distal obstruction.",
                   fr: "Signe de Courvoisier : dans la lithiase, la vésicule est habituellement fibreuse et peu distensible ; une vésicule palpable et indolore oriente donc vers une obstruction distale maligne plutôt que lithiasique.",
                   ja: "クールボアジェ徴候:胆石症では胆嚢は線維化して伸展しにくいため、無痛性で触知可能な胆嚢は結石ではなく悪性の遠位閉塞を示唆します。" } },
  { id: "q12",
    q: { en: "Which is the appropriate FIRST imaging test in suspected obstructive jaundice?",
         fr: "Quel est le premier examen d'imagerie approprié devant un ictère obstructif suspecté ?",
         ja: "閉塞性黄疸が疑われる場合、最初に行うべき画像検査はどれですか?" },
    options: [
      { text: { en: "Abdominal ultrasound",
                fr: "Une échographie abdominale",
                ja: "腹部超音波検査" }, correct: true },
      { text: { en: "Immediate ERCP",
                fr: "Une CPRE immédiate",
                ja: "直ちにERCP" } },
      { text: { en: "Plain abdominal radiograph",
                fr: "Une radiographie d'abdomen sans préparation",
                ja: "腹部単純X線" } },
      { text: { en: "PET-CT",
                fr: "Un TEP-scanner",
                ja: "PET-CT" } }
    ],
    explanation: { en: "Ultrasound confirms duct dilatation and the level of obstruction, is non-invasive and cheap, and directs the choice of cross-sectional imaging.",
                   fr: "L'échographie confirme la dilatation des voies biliaires et le niveau de l'obstacle, reste non invasive et peu coûteuse, et oriente le choix de l'imagerie en coupes.",
                   ja: "超音波は胆管拡張と閉塞部位を確認でき、非侵襲的かつ安価で、次の断層撮影の選択を導きます。" } },
  { id: "q13",
    q: { en: "Which liver-test pattern best indicates cholestasis?",
         fr: "Quel profil de bilan hépatique traduit le mieux une cholestase ?",
         ja: "胆汁うっ滞を最もよく示す肝機能検査のパターンはどれですか?" },
    options: [
      { text: { en: "Raised ALP and GGT with conjugated hyperbilirubinaemia, transaminases proportionally lower",
                fr: "PAL et GGT élevées avec hyperbilirubinémie conjuguée, transaminases proportionnellement moins élevées",
                ja: "ALPとγ-GTPの上昇と直接ビリルビン優位の高ビリルビン血症、トランスアミナーゼは相対的に低い" }, correct: true },
      { text: { en: "Transaminases in the thousands with a normal ALP",
                fr: "Transaminases à plusieurs milliers avec PAL normales",
                ja: "トランスアミナーゼが数千でALPは正常" } },
      { text: { en: "Isolated unconjugated hyperbilirubinaemia",
                fr: "Hyperbilirubinémie non conjuguée isolée",
                ja: "間接ビリルビン優位の単独上昇" } },
      { text: { en: "Isolated low albumin",
                fr: "Hypoalbuminémie isolée",
                ja: "アルブミン低値のみ" } }
    ],
    explanation: { en: "Cholestasis raises the canalicular enzymes (ALP, GGT) out of proportion to the transaminases, with a conjugated bilirubin — the opposite pattern to a hepatitic injury.",
                   fr: "La cholestase élève les enzymes canaliculaires (PAL, GGT) de façon disproportionnée par rapport aux transaminases, avec une bilirubine conjuguée — profil inverse d'une atteinte hépatitique.",
                   ja: "胆汁うっ滞では毛細胆管系酵素(ALP・γ-GTP)がトランスアミナーゼに比して不均衡に上昇し、直接ビリルビンが優位となります。肝炎型障害とは逆のパターンです。" } },
  { id: "q14",
    q: { en: "Which feature most raises concern for pancreatic head malignancy in an older adult with jaundice?",
         fr: "Quel élément fait le plus craindre un cancer de la tête du pancréas chez un sujet âgé ictérique ?",
         ja: "黄疸のある高齢者で膵頭部悪性腫瘍を最も強く疑わせる所見はどれですか?" },
    options: [
      { text: { en: "Weight loss with new-onset diabetes",
                fr: "Amaigrissement avec diabète d'apparition récente",
                ja: "体重減少と新規発症の糖尿病" }, correct: true },
      { text: { en: "Jaundice that fluctuates with meals",
                fr: "Un ictère fluctuant avec les repas",
                ja: "食事に伴って変動する黄疸" } },
      { text: { en: "A family history of Gilbert syndrome",
                fr: "Des antécédents familiaux de syndrome de Gilbert",
                ja: "ジルベール症候群の家族歴" } },
      { text: { en: "Pruritus alone",
                fr: "Un prurit isolé",
                ja: "掻痒感のみ" } }
    ],
    explanation: { en: "New-onset diabetes with weight loss in an older adult is a recognised presenting pattern of pancreatic cancer, and together with painless jaundice it should not be attributed to age.",
                   fr: "Un diabète d'apparition récente avec amaigrissement chez un sujet âgé est un mode de révélation reconnu du cancer du pancréas ; associé à un ictère indolore, il ne doit pas être mis sur le compte de l'âge.",
                   ja: "高齢者における新規発症の糖尿病と体重減少は膵癌の既知の初発様式であり、無痛性黄疸を伴う場合は加齢のせいにしてはなりません。" } },
  { id: "q15",
    q: { en: "What is the correct role of CA 19-9?",
         fr: "Quelle est la place correcte du CA 19-9 ?",
         ja: "CA19-9の正しい位置づけはどれですか?" },
    options: [
      { text: { en: "Baseline and monitoring in known disease — not diagnostic or screening, and it rises in benign cholestasis",
                fr: "Valeur de référence et suivi d'une maladie connue — ni diagnostique ni de dépistage, et il s'élève dans les cholestases bénignes",
                ja: "既知の疾患におけるベースラインと経過観察のため — 診断やスクリーニング用ではなく、良性の胆汁うっ滞でも上昇する" }, correct: true },
      { text: { en: "A screening test for pancreatic cancer in the general population",
                fr: "Un test de dépistage du cancer du pancréas en population générale",
                ja: "一般集団に対する膵癌のスクリーニング検査" } },
      { text: { en: "Diagnostic when above the reference range",
                fr: "Diagnostique dès qu'il dépasse la valeur usuelle",
                ja: "基準値を超えれば診断的" } },
      { text: { en: "Useful only after resection",
                fr: "Utile uniquement après résection",
                ja: "切除後にのみ有用" } }
    ],
    explanation: { en: "CA 19-9 rises in any cholestasis and is absent in Lewis-negative individuals, so it neither rules in nor rules out cancer; its value is as a baseline against which to track a confirmed disease.",
                   fr: "Le CA 19-9 s'élève dans toute cholestase et reste indosable chez les sujets Lewis-négatifs : il ne permet ni d'affirmer ni d'exclure un cancer ; son intérêt est de servir de référence pour suivre une maladie confirmée.",
                   ja: "CA19-9はあらゆる胆汁うっ滞で上昇し、Lewis陰性者では検出されないため、癌の確定にも除外にも使えません。確定した疾患を追跡する基準値としての価値があります。" } },
  { id: "q16",
    q: { en: "Which investigation best assesses resectability once malignancy is suspected?",
         fr: "Quel examen évalue le mieux la résécabilité lorsqu'une tumeur maligne est suspectée ?",
         ja: "悪性が疑われた後、切除可能性の評価に最も適した検査はどれですか?" },
    options: [
      { text: { en: "Contrast-enhanced pancreatic-protocol CT",
                fr: "Un scanner avec injection selon un protocole pancréatique",
                ja: "膵プロトコルによる造影CT" }, correct: true },
      { text: { en: "Repeat ultrasound",
                fr: "Une échographie de contrôle",
                ja: "超音波の再検" } },
      { text: { en: "ERCP with stenting",
                fr: "Une CPRE avec pose de prothèse",
                ja: "ステント留置を伴うERCP" } },
      { text: { en: "Liver biopsy",
                fr: "Une biopsie hépatique",
                ja: "肝生検" } }
    ],
    explanation: { en: "A pancreatic-protocol CT shows the tumour's relationship to the coeliac axis, SMA and portal/mesenteric veins — the vascular contact that decides resectability.",
                   fr: "Le scanner en protocole pancréatique montre les rapports de la tumeur avec le tronc cœliaque, l'artère mésentérique supérieure et l'axe veineux porto-mésentérique — le contact vasculaire qui décide de la résécabilité.",
                   ja: "膵プロトコルCTは腫瘍と腹腔動脈・上腸間膜動脈・門脈/腸間膜静脈との関係、すなわち切除可能性を決める血管接触を描出します。" } }
];
...
,
  ...
  { id: "q7",
    q: { en: "Immediately after the disclosure, Mrs Tanaka falls silent. The best response is:",
         fr: "Juste après l'annonce, Mme Tanaka se tait. La meilleure réponse est :",
         ja: "告知の直後、田中さんが黙り込みます。最善の応答は:" },
    options: [
      { text: { en: "Fill the silence with chemotherapy details",
                fr: "Combler le silence avec les détails de la chimiothérapie",
                ja: "化学療法の詳細で沈黙を埋める" }, correct: false },
      { text: { en: "End the consultation to give her space",
                fr: "Mettre fin à l'entretien pour lui laisser de l'espace",
                ja: "彼女に余地を与えるため面談を終える" }, correct: false },
      { text: { en: "Allow the silence, stay present, then gently check in before continuing",
                fr: "Laisser le silence, rester présent, puis prendre doucement de ses nouvelles avant de poursuivre",
                ja: "沈黙を許し、そばに居続け、続ける前に優しく様子を尋ねる" }, correct: true },
      { text: { en: "Ask her son to respond on her behalf",
                fr: "Demander à son fils de répondre à sa place",
                ja: "息子に本人に代わって答えるよう求める" }, correct: false }
    ],
    explanation: { en: "Tolerating the silence, staying present, and gently checking in before continuing is an empathic, patient-led move — consistent with the SPIKES Empathy step. Filling the silence, ending the consultation, or deferring to the son all fail to follow the patient's pace.",
                   fr: "Tolérer le silence, rester présent et prendre doucement de ses nouvelles avant de poursuivre est un geste empathique, centré sur la patiente — conforme à l'étape Empathie de SPIKES. Combler le silence, écourter l'entretien ou s'en remettre au fils ne respectent pas le rythme de la patiente.",
                   ja: "沈黙を許容し、そばに居続け、続ける前に優しく様子を尋ねることは、共感的で患者主導の対応であり — SPIKESのEmpathyのステップと一致します。沈黙を埋めたり、面談を終えたり、息子に委ねたりすることは、いずれも患者のペースに沿いません。" } },
  { id: "q8",
    q: { en: "What is the purpose of advance care planning (人生会議 / ACP)?",
         fr: "Quel est le but de la planification anticipée des soins (人生会議 / ACP) ?",
         ja: "アドバンス・ケア・プランニング(人生会議/ACP)の目的は何ですか?" },
    options: [
      { text: { en: "A one-off legal form completed by the family",
                fr: "Un formulaire juridique ponctuel rempli par la famille",
                ja: "家族が記入する一度きりの法的書類" }, correct: false },
      { text: { en: "An ongoing, patient-centred conversation about values and future care preferences, ideally before a crisis",
                fr: "Une conversation continue, centrée sur le patient, sur ses valeurs et ses préférences de soins futurs, idéalement avant une crise",
                ja: "価値観と将来のケアの希望についての、患者中心の継続的な対話 — 理想的には危機の前に行うもの" }, correct: true },
      { text: { en: "Something only relevant in the final days of life",
                fr: "Quelque chose qui ne concerne que les derniers jours de la vie",
                ja: "人生の最後の数日にのみ関係するもの" }, correct: false },
      { text: { en: "A way to transfer decisions from the patient to the doctor",
                fr: "Un moyen de transférer les décisions du patient au médecin",
                ja: "決定を患者から医師へ移す手段" }, correct: false }
    ],
    explanation: { en: "Advance care planning (人生会議 / jinsei kaigi, ACP) is an ongoing, patient-centred and anticipatory conversation about values and future care preferences, ideally begun before a crisis — not a one-off family form, a last-days-only activity, or a transfer of decisions to the doctor. It is supported by MHLW guidance (revised 2018).",
                   fr: "La planification anticipée des soins (人生会議 / jinsei kaigi, ACP) est une conversation continue, centrée sur le patient et anticipatrice, sur les valeurs et les préférences de soins futurs, idéalement engagée avant une crise — non un formulaire familial ponctuel, une activité réservée aux derniers jours, ou un transfert des décisions au médecin. Elle est soutenue par les recommandations du MHLW (révisées en 2018).",
                   ja: "アドバンス・ケア・プランニング(人生会議/ACP)は、価値観と将来のケアの希望についての、患者中心かつ先取り的な継続的対話であり、理想的には危機の前に始められます — 一度きりの家族の書類でも、最後の数日だけの活動でも、決定を医師に移すものでもありません。MHLWのガイダンス(2018改訂)に支えられています。" } },
  { id: "q9",
    q: { en: "How should a clinician regard softer Japanese clinical language such as 進行 (advanced) or 限られた時間 (limited time) when breaking bad news?",
         fr: "Comment un clinicien doit-il considérer un langage clinique japonais plus doux, tel que 進行 (avancé) ou 限られた時間 (temps limité), lors de l'annonce d'une mauvaise nouvelle ?",
         ja: "悪い知らせを告げる際、進行(advanced)や限られた時間(limited time)といったより柔らかな日本語の臨床表現を、臨床医はどう捉えるべきですか?" },
    options: [
      { text: { en: "It is always dishonest and should be avoided",
                fr: "C'est toujours malhonnête et cela doit être évité",
                ja: "常に不誠実であり、避けるべきである" }, correct: false },
      { text: { en: "It is always preferable to plain words",
                fr: "C'est toujours préférable aux mots simples",
                ja: "常に率直な言葉より好ましい" }, correct: false },
      { text: { en: "It can be a legitimate, culturally-appropriate way to convey seriousness — provided you check the patient actually understands the meaning",
                fr: "Cela peut être une manière légitime et culturellement adaptée de transmettre la gravité — à condition de vérifier que la patiente en comprend bien le sens",
                ja: "重大さを伝える正当で文化的に適切な手段となりうる — ただし患者がその意味を実際に理解しているかを確認することが条件である" }, correct: true },
      { text: { en: "It has no effect on the patient's understanding",
                fr: "Cela n'a aucun effet sur la compréhension de la patiente",
                ja: "患者の理解に何の影響も及ぼさない" }, correct: false }
    ],
    explanation: { en: "Softer Japanese clinical language (進行, 限られた時間) is not automatically deception — it can be a legitimate, culturally-appropriate way to convey seriousness. The essential safeguard is to confirm that the patient actually understands the meaning, in keeping with patient-centred disclosure (MHLW guidance).",
                   fr: "Un langage clinique japonais plus doux (進行, 限られた時間) n'est pas automatiquement un mensonge — il peut être une manière légitime et culturellement adaptée de transmettre la gravité. La précaution essentielle est de confirmer que la patiente en comprend réellement le sens, dans l'esprit d'une annonce centrée sur le patient (recommandations du MHLW).",
                   ja: "より柔らかな日本語の臨床表現(進行、限られた時間)は、自動的に欺瞞となるわけではなく — 重大さを伝える正当で文化的に適切な手段となりえます。本質的な歯止めは、患者がその意味を実際に理解しているかを確認することであり、患者中心の告知の精神に沿います(MHLWガイダンス)。" } },
  { id: "q10",
    q: { en: "What is the single most transferable lesson for breaking bad news across cultures?",
         fr: "Quelle est la leçon la plus transférable pour l'annonce de mauvaises nouvelles à travers les cultures ?",
         ja: "文化を越えて悪い知らせを告げるうえで、最も応用の利く唯一の教訓は何ですか?" },
    options: [
      { text: { en: "Apply your own country's default everywhere",
                fr: "Appliquer partout la norme par défaut de son propre pays",
                ja: "自国のデフォルトをどこでも適用する" }, correct: false },
      { text: { en: "Always defer to the family's wishes",
                fr: "Toujours s'en remettre aux souhaits de la famille",
                ja: "常に家族の希望に従う" }, correct: false },
      { text: { en: "Avoid discussing prognosis altogether",
                fr: "Éviter d'aborder le pronostic dans son ensemble",
                ja: "予後の話を一切避ける" }, correct: false },
      { text: { en: "Ask the individual patient her own preferences (who to involve, how much to know, which words) rather than assuming a national or cultural script",
                fr: "Demander à chaque patiente ses propres préférences (qui impliquer, combien savoir, quels mots) plutôt que de présumer un scénario national ou culturel",
                ja: "国や文化の筋書きを前提とせず、患者一人ひとりに本人の希望(誰を関与させるか、どこまで知りたいか、どの言葉を用いるか)を尋ねる" }, correct: true }
    ],
    explanation: { en: "The most transferable lesson is to ask the individual patient her own preferences — who to involve, how much to know, which words — rather than assuming a national or cultural script. Individualised, patient-led disclosure beats any cultural stereotype; the French and Japanese systems converge more than they differ.",
                   fr: "La leçon la plus transférable est de demander à chaque patiente ses propres préférences — qui impliquer, combien savoir, quels mots — plutôt que de présumer un scénario national ou culturel. Une annonce individualisée et centrée sur la patiente l'emporte sur tout stéréotype culturel ; les systèmes français et japonais convergent plus qu'ils ne divergent.",
                   ja: "最も応用の利く教訓は、国や文化の筋書きを前提とするのではなく、患者一人ひとりに本人の希望 — 誰を関与させるか、どこまで知りたいか、どの言葉を用いるか — を尋ねることです。個別化された患者主導の告知は、いかなる文化的ステレオタイプにも勝ります;フランスと日本の制度は、相違よりも収束のほうが大きいのです。" } },
  { id: "q11",
    q: { en: "Before starting palliative chemotherapy, what is required?",
         fr: "Avant de débuter une chimiothérapie palliative, qu'exige-t-on ?",
         ja: "緩和的化学療法を開始する前に必要なものはどれですか?" },
    options: [
      { text: { en: "A tissue diagnosis, usually by EUS-guided fine-needle biopsy",
                fr: "Un diagnostic histologique, généralement par ponction sous échoendoscopie",
                ja: "通常はEUS下穿刺による組織診断" }, correct: true },
      { text: { en: "Imaging alone is sufficient",
                fr: "L'imagerie seule suffit",
                ja: "画像のみで十分" } },
      { text: { en: "A raised CA 19-9 is sufficient",
                fr: "Un CA 19-9 élevé suffit",
                ja: "CA19-9高値で十分" } },
      { text: { en: "Nothing further",
                fr: "Rien de plus",
                ja: "追加は不要" } }
    ],
    explanation: { en: "Chemotherapy commits the patient to real toxicity, so the diagnosis must be histological — imaging and tumour markers can both mislead, including in benign masses that mimic carcinoma.",
                   fr: "La chimiothérapie expose à une toxicité réelle : le diagnostic doit donc être histologique — l'imagerie comme les marqueurs peuvent égarer, notamment devant des masses bénignes simulant un carcinome.",
                   ja: "化学療法は実際の毒性を伴うため、診断は組織学的でなければなりません。画像も腫瘍マーカーも、癌に類似する良性腫瘤を含めて誤らせることがあります。" } },
  { id: "q12",
    q: { en: "In a patient who may still be resectable, why is a staging CT preferred BEFORE ERCP and stenting?",
         fr: "Chez une patiente peut-être encore résécable, pourquoi préférer un scanner de bilan AVANT la CPRE et la pose de prothèse ?",
         ja: "まだ切除可能かもしれない患者で、ERCPとステント留置の前に病期診断CTを優先するのはなぜですか?" },
    options: [
      { text: { en: "A stent introduces inflammatory change and artefact that degrade staging accuracy, and ERCP carries a pancreatitis risk",
                fr: "La prothèse induit des remaniements inflammatoires et des artefacts qui dégradent la précision du bilan, et la CPRE expose à une pancréatite",
                ja: "ステントは炎症性変化とアーチファクトを生じて病期診断の精度を落とし、ERCPには膵炎のリスクがある" }, correct: true },
      { text: { en: "ERCP is contraindicated in malignancy",
                fr: "La CPRE est contre-indiquée en cas de cancer",
                ja: "悪性疾患ではERCPは禁忌" } },
      { text: { en: "CT cannot be performed after stenting",
                fr: "Le scanner est impossible après la pose de prothèse",
                ja: "ステント留置後はCTを施行できない" } },
      { text: { en: "It shortens the admission",
                fr: "Cela raccourcit l'hospitalisation",
                ja: "入院期間が短くなる" } }
    ],
    explanation: { en: "The order matters: a decision taken for comfort can cost the resectability assessment. Drainage first is right when the patient is septic or in renal failure — this patient is neither.",
                   fr: "L'ordre compte : un geste décidé pour le confort peut faire perdre l'évaluation de la résécabilité. Drainer d'abord se justifie chez un patient septique ou en insuffisance rénale — ce n'est pas le cas ici.",
                   ja: "順序が重要です。快適さのための処置が切除可能性の評価を損ないうるからです。敗血症や腎不全があれば先にドレナージが正しいですが、本症例は該当しません。" } },
  { id: "q13",
    q: { en: "A patient with pancreatic cancer reports greasy, floating stools and continued weight loss despite eating. What should be offered?",
         fr: "Une patiente atteinte d'un cancer du pancréas décrit des selles grasses et flottantes et un amaigrissement qui se poursuit malgré une alimentation conservée. Que proposer ?",
         ja: "膵癌の患者が、食事は摂れているのに脂肪性で水に浮く便と体重減少の持続を訴えています。何を提供すべきですか?" },
    options: [
      { text: { en: "Pancreatic enzyme replacement therapy with dietetic input",
                fr: "Une supplémentation en enzymes pancréatiques avec avis diététique",
                ja: "膵酵素補充療法と栄養士の関与" }, correct: true },
      { text: { en: "A low-fat diet alone",
                fr: "Un régime pauvre en graisses seul",
                ja: "低脂肪食のみ" } },
      { text: { en: "Loperamide",
                fr: "Du lopéramide",
                ja: "ロペラミド" } },
      { text: { en: "No action; this is expected",
                fr: "Aucune mesure ; c'est attendu",
                ja: "対応不要。予想される経過である" } }
    ],
    explanation: { en: "Steatorrhoea here is exocrine insufficiency, not the cancer being untreatable. Enzyme replacement is one of the few interventions that reliably improves weight and quality of life — and it is routinely forgotten.",
                   fr: "La stéatorrhée traduit ici une insuffisance exocrine, et non un cancer « qu'on ne peut plus traiter ». La substitution enzymatique est l'une des rares mesures qui améliorent réellement le poids et la qualité de vie — et on l'oublie régulièrement.",
                   ja: "ここでの脂肪便は膵外分泌不全であり、癌が治療不能であることの表れではありません。酵素補充は体重と生活の質を確実に改善する数少ない介入であり、しばしば見落とされます。" } },
  { id: "q14",
    q: { en: "What does the evidence show about introducing palliative care early in advanced pancreatic cancer?",
         fr: "Que montrent les données sur l'introduction précoce des soins palliatifs dans le cancer du pancréas avancé ?",
         ja: "進行膵癌における早期からの緩和ケア導入について、エビデンスは何を示していますか?" },
    options: [
      { text: { en: "It improves quality of life and symptom control, and is compatible with ongoing oncological treatment",
                fr: "Ils améliorent la qualité de vie et le contrôle des symptômes, et sont compatibles avec la poursuite du traitement oncologique",
                ja: "生活の質と症状コントロールを改善し、進行中の腫瘍治療と両立する" }, correct: true },
      { text: { en: "It should wait until chemotherapy is stopped",
                fr: "Ils doivent attendre l'arrêt de la chimiothérapie",
                ja: "化学療法を中止してから導入すべき" } },
      { text: { en: "It shortens survival",
                fr: "Ils raccourcissent la survie",
                ja: "生存期間を短縮する" } },
      { text: { en: "It applies only in the last days of life",
                fr: "Ils ne concernent que les tout derniers jours de vie",
                ja: "終末期の数日間にのみ適用される" } }
    ],
    explanation: { en: "Early palliative care runs alongside oncological treatment rather than replacing it. Framing it as \"giving up\" is the commonest reason it is offered too late.",
                   fr: "Les soins palliatifs précoces accompagnent le traitement oncologique au lieu de s'y substituer. Les présenter comme un « abandon » est la raison la plus fréquente de leur mise en route trop tardive.",
                   ja: "早期緩和ケアは腫瘍治療に取って代わるのではなく並行して行われます。「あきらめ」と位置づけることが、導入が遅れる最も多い理由です。" } }
];
...
,
  ...
  {
    id: "q7",
    q: { en: "A patient asks for an antibiotic and does not get one. What does the evidence say about their satisfaction with the consultation?",
         fr: "Un patient demande un antibiotique et n'en obtient pas. Que dit la littérature sur sa satisfaction vis-à-vis de la consultation ?",
         ja: "患者が抗菌薬を求め、処方されなかった場合、その診察への満足度について研究は何を示していますか?" },
    options: [
      { text: { en: "Satisfaction tracks feeling understood and leaving with a plan — not whether a prescription was issued",
                fr: "La satisfaction dépend du sentiment d'avoir été compris et de repartir avec un plan — non de la délivrance d'une ordonnance",
                ja: "満足度は、理解されたと感じられたかと計画を持ち帰れたかに左右され、処方の有無ではない" }, correct: true },
      { text: { en: "Satisfaction falls sharply whenever an antibiotic is withheld",
                fr: "La satisfaction chute fortement dès qu'un antibiotique est refusé",
                ja: "抗菌薬が出されないと満足度は急激に低下する" }, correct: false },
      { text: { en: "Satisfaction is determined almost entirely by waiting time",
                fr: "La satisfaction est déterminée presque entièrement par le temps d'attente",
                ja: "満足度はほぼ待ち時間だけで決まる" }, correct: false },
      { text: { en: "Satisfaction is unrelated to anything that happens in the consultation",
                fr: "La satisfaction n'a aucun rapport avec ce qui se passe pendant la consultation",
                ja: "満足度は診察の中で起きることとは無関係である" }, correct: false }
    ],
    explanation: { en: "This is the finding that makes stewardship survivable in practice: across primary-care studies, patients rate a consultation on whether their concern was taken seriously and whether they left knowing what to do — a prescription is a proxy for those, not the source of them. It is also why a bare \"no\" performs badly: it withholds the prescription AND the plan.",
                   fr: "C'est le résultat qui rend le bon usage tenable en pratique : dans les études en soins primaires, les patients jugent une consultation sur le fait que leur préoccupation a été prise au sérieux et qu'ils repartent en sachant quoi faire — l'ordonnance en est un substitut, non la source. C'est aussi pourquoi un « non » sec fonctionne mal : il retire l'ordonnance ET le plan.",
                   ja: "これは適正使用を実務で成立させる知見です。プライマリ・ケアの研究では、患者は「自分の心配が真剣に受け止められたか」「何をすべきか分かって帰れたか」で診察を評価しており、処方はその代理指標にすぎません。素っ気ない「ノー」がうまくいかないのは、処方だけでなく計画までも取り上げてしまうからです。" } },
  {
    id: "q8",
    q: { en: "Which factor most strongly predicts that an antibiotic will be prescribed for a viral respiratory illness?",
         fr: "Quel facteur prédit le plus fortement la prescription d'un antibiotique pour une infection respiratoire virale ?",
         ja: "ウイルス性呼吸器感染症で抗菌薬が処方されることを最も強く予測する要因はどれですか?" },
    options: [
      { text: { en: "The clinician's BELIEF that the patient expects one — which is frequently wrong",
                fr: "La CROYANCE du clinicien que le patient en attend un — croyance souvent erronée",
                ja: "患者が期待しているという医師の「思い込み」— それはしばしば誤っている" }, correct: true },
      { text: { en: "The patient's explicitly stated request",
                fr: "La demande explicitement formulée par le patient",
                ja: "患者が明確に口にした要望" }, correct: false },
      { text: { en: "The measured temperature at presentation",
                fr: "La température mesurée lors de la consultation",
                ja: "受診時に測定された体温" }, correct: false },
      { text: { en: "The duration of symptoms before presentation",
                fr: "La durée des symptômes avant la consultation",
                ja: "受診前の症状持続期間" }, correct: false }
    ],
    explanation: { en: "Repeatedly, clinicians who believed a patient wanted an antibiotic prescribed far more often — and their belief matched what the patient actually wanted only about half the time. Many patients who are assumed to want a prescription in fact want an explanation and a plan. Asking directly (\"what were you hoping we'd do today?\") dissolves most of this gap, which is why it is the first move in the roleplay.",
                   fr: "De façon répétée, les cliniciens convaincus qu'un patient voulait un antibiotique en prescrivaient bien plus souvent — et leur conviction correspondait à l'attente réelle du patient environ une fois sur deux seulement. Beaucoup de patients supposés vouloir une ordonnance veulent en fait une explication et un plan. Poser directement la question (« qu'espériez-vous que nous fassions aujourd'hui ? ») dissout l'essentiel de cet écart : c'est pourquoi c'est le premier geste du jeu de rôle.",
                   ja: "繰り返し示されているのは、患者が抗菌薬を望んでいると考えた医師ほど処方が多く、しかもその推測が実際の患者の希望と一致したのは半分程度だったという事実です。処方を望んでいると見なされた患者の多くは、実際には説明と計画を求めています。「今日はどうなることを期待して来られましたか」と直接尋ねることでこの隔たりの大半は解消します。ロールプレイで最初に行うのはそのためです。" } },
  {
    id: "q9",
    q: { en: "What makes safety-netting advice actually work?",
         fr: "Qu'est-ce qui rend efficaces les consignes de reconsultation (safety netting) ?",
         ja: "セーフティネットの説明が実際に機能するために必要なのは何ですか?" },
    options: [
      { text: { en: "Naming the expected course with a time frame, the specific features that should prompt return, and exactly where to go",
                fr: "Nommer l'évolution attendue avec un délai, les signes précis devant faire reconsulter, et exactement où se rendre",
                ja: "予想される経過を期間とともに示し、受診すべき具体的な症状と、どこに行けばよいかを明確に伝えること" }, correct: true },
      { text: { en: "Telling the patient to come back if they are not better",
                fr: "Dire au patient de revenir s'il ne va pas mieux",
                ja: "よくならなければまた来てくださいと伝えること" }, correct: false },
      { text: { en: "Booking a routine review appointment for every patient",
                fr: "Programmer une consultation de contrôle systématique pour chaque patient",
                ja: "すべての患者に定期の再診予約を入れること" }, correct: false },
      { text: { en: "Providing a written leaflet instead of a verbal explanation",
                fr: "Remettre une brochure écrite au lieu d'une explication orale",
                ja: "口頭の説明の代わりに印刷物を渡すこと" }, correct: false }
    ],
    explanation: { en: "\"Come back if you're not better\" gives the patient no way to tell normal from dangerous, so it converts either into a return visit or into a dangerous wait. Sore throat: expect the worst days 3-4 and gradual settling over about a week; return for difficulty swallowing saliva, inability to open the mouth, a swelling or a voice change, or new high fever after improvement. A leaflet supports the conversation but does not replace it (NICE NG84).",
                   fr: "« Revenez si vous n'allez pas mieux » ne donne au patient aucun moyen de distinguer le normal du dangereux : cela se traduit soit par une reconsultation, soit par une attente dangereuse. Angine : pic de gêne vers J3-J4 puis amélioration progressive sur environ une semaine ; reconsulter en cas de difficulté à avaler la salive, d'impossibilité d'ouvrir la bouche, d'une tuméfaction ou d'un changement de voix, ou d'une fièvre élevée réapparaissant après amélioration. La brochure appuie l'échange mais ne le remplace pas (NICE NG84).",
                   ja: "「よくならなければまた来てください」では、正常と危険を見分ける手がかりが患者に何も残らず、不要な再診か危険な様子見のどちらかを招きます。咽頭痛なら、3〜4日目が最もつらく1週間ほどで徐々に軽快すること、唾液が飲み込めない・口が開かない・腫脹や声の変化・改善後の新たな高熱があれば受診すること。印刷物は会話を補うものであって代わりにはなりません(NICE NG84)。" } }
];
...
,
  ...
  {
    id: "q7",
    q: { en: "A different patient has Centor/McIsaac 4 and a POSITIVE rapid antigen detection test (RADT) for group A strep. What does that result actually establish?",
         fr: "Une autre patiente a un score de Centor/McIsaac à 4 et un test de diagnostic rapide (TDR) POSITIF pour le streptocoque du groupe A. Qu'établit réellement ce résultat ?",
         ja: "別の患者はCentor/McIsaac 4点で、A群溶連菌の迅速抗原検査(RADT)が陽性でした。この結果が実際に示すのは何ですか?" },
    options: [
      { text: { en: "It is highly specific, so a positive result confirms GAS and justifies treating — while a NEGATIVE result is the one that can miss cases",
                fr: "Il est très spécifique : un résultat positif confirme le SGA et justifie le traitement — c'est le résultat NÉGATIF qui peut manquer des cas",
                ja: "特異度が高いため陽性であればGASと確定でき治療が正当化される — 見逃しが起こりうるのは「陰性」のほうである" }, correct: true },
      { text: { en: "It distinguishes true infection from asymptomatic carriage",
                fr: "Il distingue une infection vraie d'un portage asymptomatique",
                ja: "真の感染と無症候性保菌とを区別できる" }, correct: false },
      { text: { en: "It is more sensitive than throat culture",
                fr: "Il est plus sensible que la culture de gorge",
                ja: "咽頭培養より感度が高い" }, correct: false },
      { text: { en: "It predicts which patients will develop rheumatic fever",
                fr: "Il prédit quels patients développeront un rhumatisme articulaire aigu",
                ja: "どの患者がリウマチ熱を発症するかを予測できる" }, correct: false }
    ],
    explanation: { en: "RADT specificity is roughly 95% and sensitivity roughly 85%, so a positive is trustworthy and a negative in a high-score patient is the one that may warrant culture (practice differs: many European guidelines accept the RADT alone in adults). Note what it cannot do: 5-20% of healthy people carry GAS, so a positive test in a patient whose illness is actually viral looks identical — which is exactly why testing is reserved for higher Centor scores rather than offered to everyone.",
                   fr: "La spécificité du TDR est d'environ 95 % et sa sensibilité d'environ 85 % : un positif est fiable, et c'est un négatif chez un patient à score élevé qui peut justifier une culture (les pratiques diffèrent : de nombreuses recommandations européennes acceptent le TDR seul chez l'adulte). Ce qu'il ne peut pas faire : 5 à 20 % des sujets sains sont porteurs de SGA, si bien qu'un test positif chez un patient dont la maladie est en réalité virale est indiscernable — raison pour laquelle le test est réservé aux scores de Centor élevés et non proposé à tous.",
                   ja: "RADTの特異度は約95%、感度は約85%です。したがって陽性は信頼でき、スコアの高い患者での陰性こそ培養を考慮する対象となります(実務は地域により異なり、成人ではRADT単独を認めるヨーロッパのガイドラインも多い)。できないこともあります。健常者の5〜20%はGASを保菌しているため、実際にはウイルス性の患者での陽性も同じに見えます。検査をCentorの高スコアに限る理由はまさにここにあります。" } },
  {
    id: "q8",
    q: { en: "If group A strep IS confirmed and you decide to treat, which complication does antibiotic treatment reliably reduce?",
         fr: "Si le streptocoque du groupe A est confirmé et que vous décidez de traiter, quelle complication le traitement antibiotique réduit-il de façon fiable ?",
         ja: "A群溶連菌が確定し治療する場合、抗菌薬が確実に減らせる合併症はどれですか?" },
    options: [
      { text: { en: "Acute rheumatic fever — and, to a lesser degree, suppurative complications such as peritonsillar abscess",
                fr: "Le rhumatisme articulaire aigu — et, dans une moindre mesure, les complications suppuratives comme l'abcès péri-amygdalien",
                ja: "急性リウマチ熱 — および程度は劣るが扁桃周囲膿瘍などの化膿性合併症" }, correct: true },
      { text: { en: "Post-streptococcal glomerulonephritis",
                fr: "La glomérulonéphrite post-streptococcique",
                ja: "溶連菌感染後急性糸球体腎炎" }, correct: false },
      { text: { en: "All post-streptococcal complications equally",
                fr: "Toutes les complications post-streptococciques de manière équivalente",
                ja: "すべての溶連菌感染後合併症を等しく" }, correct: false },
      { text: { en: "Recurrence of sore throat within the next year",
                fr: "La récidive d'angine dans l'année suivante",
                ja: "翌年以内の咽頭痛の再発" }, correct: false }
    ],
    explanation: { en: "Antibiotics prevent acute rheumatic fever — the historical justification for treating strep throat at all — and shorten symptoms by roughly a day. They do NOT prevent post-streptococcal glomerulonephritis. In France and Japan, where rheumatic fever incidence is now very low, that asymmetry is precisely why the treatment threshold has moved and why score-guided testing replaced treating every sore throat.",
                   fr: "Les antibiotiques préviennent le rhumatisme articulaire aigu — la justification historique du traitement de l'angine streptococcique — et raccourcissent les symptômes d'environ un jour. Ils ne préviennent PAS la glomérulonéphrite post-streptococcique. En France et au Japon, où l'incidence du RAA est aujourd'hui très faible, cette asymétrie est précisément la raison pour laquelle le seuil de traitement s'est déplacé et pour laquelle le test guidé par un score a remplacé le traitement de toute angine.",
                   ja: "抗菌薬は急性リウマチ熱を予防し(そもそも溶連菌性咽頭炎を治療する歴史的な根拠がこれです)、症状を約1日短縮します。しかし溶連菌感染後糸球体腎炎は予防しません。リウマチ熱の発生率が非常に低くなった日本やフランスでは、この非対称性こそが治療閾値を移動させ、すべての咽頭痛を治療する方針からスコアに基づく検査へと変えた理由です。" } },
  {
    id: "q9",
    q: { en: "You are treating confirmed group A strep pharyngitis in an adult with no allergy. What is first-line?",
         fr: "Vous traitez une angine à streptocoque du groupe A confirmée chez un adulte sans allergie. Quel est le traitement de première intention ?",
         ja: "アレルギーのない成人で、確定したA群溶連菌性咽頭炎を治療します。第一選択は何ですか?" },
    options: [
      { text: { en: "Narrow-spectrum penicillin (penicillin V, or amoxicillin) — GAS has never developed penicillin resistance",
                fr: "Une pénicilline à spectre étroit (pénicilline V, ou amoxicilline) — le SGA n'a jamais développé de résistance à la pénicilline",
                ja: "狭域のペニシリン(ペニシリンVまたはアモキシシリン)— GASはペニシリン耐性を獲得したことがない" }, correct: true },
      { text: { en: "A macrolide such as azithromycin, as first choice",
                fr: "Un macrolide comme l'azithromycine, en premier choix",
                ja: "第一選択としてアジスロマイシンなどのマクロライド" }, correct: false },
      { text: { en: "Co-amoxiclav, to cover beta-lactamase producers",
                fr: "L'amoxicilline-acide clavulanique, pour couvrir les producteurs de bêta-lactamase",
                ja: "βラクタマーゼ産生菌をカバーするためのアモキシシリン・クラブラン酸" }, correct: false },
      { text: { en: "A fluoroquinolone, for reliable tissue penetration",
                fr: "Une fluoroquinolone, pour une bonne diffusion tissulaire",
                ja: "組織移行性を期待したフルオロキノロン" }, correct: false }
    ],
    explanation: { en: "Group A strep remains uniformly penicillin-susceptible, so the narrowest agent is also the most effective one — an unusually easy stewardship decision. Macrolides are reserved for true penicillin allergy (and GAS macrolide resistance is substantial in Japan), while co-amoxiclav and fluoroquinolones add spectrum, cost and harm without adding benefit. Note the case-specific trap: if the illness is actually EBV, amoxicillin is what produces the rash — which is why the decision to test comes before the decision to treat.",
                   fr: "Le SGA reste uniformément sensible à la pénicilline : l'agent le plus étroit est donc aussi le plus efficace — une décision de bon usage exceptionnellement simple. Les macrolides sont réservés à l'allergie vraie à la pénicilline (et la résistance du SGA aux macrolides est importante au Japon), tandis que l'amoxicilline-clavulanate et les fluoroquinolones ajoutent du spectre, du coût et des effets indésirables sans bénéfice. Piège propre au cas : si la maladie est en fait une MNI, c'est l'amoxicilline qui provoque le rash — d'où la décision de tester avant la décision de traiter.",
                   ja: "A群溶連菌は一様にペニシリン感受性を保っており、最も狭域の薬剤が最も有効でもあります — 適正使用の判断としては例外的に容易です。マクロライドは真のペニシリンアレルギーに限られ(日本ではGASのマクロライド耐性が相当程度みられます)、アモキシシリン・クラブラン酸やフルオロキノロンはスペクトラム・費用・有害事象を増やすだけで利益を加えません。この症例特有の落とし穴として、実際がEBVであればアモキシシリンこそが皮疹を生じます。治療の判断の前に検査の判断が来るのはそのためです。" } }
];
