...
(function (root, factory) {
  ...
  "modA.chart.hypotheses.hint": "Mettez-vous d'accord en équipe : <strong>qu'est-ce que vous suspectez ?</strong> Listez <strong>deux diagnostics différentiels ou plus</strong> à confirmer ou à éliminer. En écrire deux débloque la synthèse clinique et les questions de discussion.",
  ...
  "modA.chart.synthesis.title": "Synthèse clinique",
  "modA.chart.synthesis.locked-hint": "Écrivez au moins <strong>deux</strong> hypothèses de travail ci-dessus pour débloquer la synthèse clinique et les questions de discussion.",
  ...
  "modA.coach.gather": "Faites le bilan du cas — interrogez, examinez, investiguez. Quand vous serez prêt·e·s, écrivez deux hypothèses de travail pour débloquer la synthèse clinique et la discussion.",
  "modA.coach.open-discussion": "✓ Hypothèses posées — la synthèse clinique et le Débat sont ouverts. Faites la synthèse, puis débattez des questions (une voix de Caen et une de Nagoya sur chaque question de comparaison).",
  ...
  "modA.synthesis.unlocked": "✓ Criblage des drapeaux rouges complet.",
