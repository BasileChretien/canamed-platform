...
module.exports = defineConfig({
  ...
  projects: [
    ...
    // ---- mobile / tablet device emulation pass ----
    {
      ...
      testMatch: /(?:mobile|lazy-locale-consent|survey-feedback|lobby-form-semantics|lobby-join-density|facilitator-profile|modb-role-objective|case-cluster-by-category|investigations-anytime|modb-observer-dark|modA-autoopen-steps|modA-llm-stub|modb-phase-flow|modb-exchange-answers|student-pdf|verify-page|splash-authored-scenarios|mobile-bottom-tabbar|vote-tally-access)\.spec\.js$/
    },
    {
      name: "mobile-ipad",
