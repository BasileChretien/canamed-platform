...
(function (root, factory) {
  ...
  "modA.answers.title": "一緒に話し合う — モジュールA",
  "modA.answers.rule": "🗣️ <strong>グループで症例について話し合いましょう</strong> — フランスと日本の疼痛管理の違いも含めて — そのうえで、下の2つの欄に回答を記入してください。",
  "modA.answers.bullet.plan.label": "1. この患者へのあなたのグループの第一選択の方針",
  "modA.answers.bullet.plan.placeholder": "例: NSAID + アクティブ・リハ ; 4週間後に再評価",
  "modA.answers.bullet.differ.label": "2. <strong>疼痛管理</strong>におけるフランスと日本の <strong>文化的な違い</strong> を一つ",
  "modA.answers.bullet.differ.placeholder": "例: 強オピオイドの処方のしやすさ、患者の期待、規制の違いなど",
  ...
  "modA.answers.complete.msg": "✓ 2つの回答が揃いました。ロールプレイの準備はいいですか？",
  ...
  "modA.coach.open-discussion": "✓ 仮説が出ました — 「一緒に話し合う」を開きましょう。グループで症例と、フランスと日本の疼痛管理の違いについて話し合い、計画と主要な違いを記入してください。",
  "modA.coach.in-discussion": "グループで質問について議論してください — 準備ができたら「グループ回答」を開いて4つの要点を記録しましょう。",
  "modA.coach.bullets-partial": "回答を記録中 — あと{n}つ追加してください(計画＋フランス/日本の違い)。",
  "modA.coach.bullets-complete": "✓ 2つの回答が記録されました。さらに加筆するか、ファシリテーターをお待ちください。",
