...
(function (root, factory) {
  ...
  "splash.enter.go-account": "Mit Google oder E-Mail anmelden, um Profil und Verlauf zu speichern →",
  "splash.enter.go-author": "Eigene Szenarien erstellen oder bearbeiten →",
  "splash.account.title": "In Ihrem Konto anmelden",
  "splash.account.subtitle": "Melden Sie sich mit Google oder mit einer E-Mail-Adresse und einem Passwort an. Ihre Angaben werden bei jedem Sitzungsbeitritt automatisch ausgefüllt, und die Sitzungen, an denen Sie teilgenommen haben — sowie die von Ihnen erstellten Szenarien — werden in Ihrem Profil gespeichert.",
  "splash.account.continue-google": "Mit Google fortfahren",
  "splash.account.or": "— oder per E-Mail —",
  "splash.account.email-label": "E-Mail",
  "splash.account.password-label": "Passwort",
  "splash.account.signin-email": "Anmelden",
  "splash.account.signup-email": "Konto erstellen",
  ...
  "splash.created.recovery-title": "Wiederherstellungscode — jetzt notieren",
  "splash.created.recovery-copy": "Kopieren",
  "splash.created.recovery-warn": "Dies ist die EINZIGE Möglichkeit, das Sitzungspasswort zurückzusetzen, falls Sie es vergessen. Er wird nicht erneut angezeigt. Halten Sie ihn geheim — wer ihn besitzt, kann das Passwort dieser Sitzung zurücksetzen.",
  "splash.created.recovery-copied": "Wiederherstellungscode kopiert!",
  "splash.created.recovery-copy-fail": "Kopieren fehlgeschlagen — notieren Sie den Wiederherstellungscode manuell.",
  "lobby.recovery-code-label": "Wiederherstellungscode (zum Zurücksetzen eines vergessenen Passworts)",
  "lobby.recovery-code-placeholder": "xxxx-xxxx-xxxx",
  "lobby.superadmin.bad-recovery": "Dieser Wiederherstellungscode passt nicht zu dieser Sitzung. Prüfen Sie den Code, den Sie bei der Erstellung der Sitzung gespeichert haben.",
  "lobby.superadmin.db-error": "Die Sitzungsdatenbank konnte nicht erreicht werden.",
  "lobby.forgot-pass-link": "Admin-Passwort festlegen oder wiederherstellen? ›",
  ...
  "lobby.consent-transcript": "Ich willige zusätzlich ein, dass die schriftliche Transkription UND die Audio-/Videoaufzeichnung der per Videokonferenz durchgeführten Sitzungen für die CaNaMED-Studie aufbewahrt und ausgewertet werden. Die Transkription wird vom Videokonferenz-Werkzeug (Microsoft Teams) automatisch erstellt und führt meinen Namen bei jedem meiner Wortbeiträge auf; die Aufzeichnung der Sitzung wird ebenfalls aufbewahrt, nicht nur die Transkription. Beide werden fünf Jahre lang nach der Veröffentlichung aufbewahrt, mit denselben eingeschränkten Zugriffsrechten wie der übrige Forschungsdatensatz, und ich kann jederzeit ihre Löschung verlangen. Es wird keine Fotografie angefertigt, und ich bin nicht verpflichtet, meine Kamera einzuschalten. Ich kann am Workshop teilnehmen, ohne dieses dritte Kästchen und ohne das Forschungskästchen oben anzukreuzen — eine Verweigerung hat keinerlei Auswirkungen auf meine Teilnahme, meine Noten oder meine Stellung an meiner Universität.",
  "lobby.consent-version": "Hinweisversion PIS v11 · 2026-09. ",
  ...
  "lobby.privacy.controller-default": "Das CaNaMED-Forschungsteam (<strong>Université de Caen Normandie × Universität Nagoya</strong>, gemeinsame Verantwortliche nach Art. 26 DSGVO / gemeinsame Nutzer nach Art. 27(5) APPI)",
  "lobby.privacy.controller-named": "<strong>{name}</strong>, verantwortliche Stelle für diese Sitzung,",
  "lobby.privacy.p1": "{controller} erhebt Ihren Vornamen oder Spitznamen, Ihre Universität, Ihr Studienjahr und Ihr selbst eingeschätztes Englischniveau. Ihr Name ist für alle Personen in Ihrem Raum sichtbar und erscheint neben den Punkten, die Sie beitragen.",
  ...
  "lobby.privacy.p3": "Die Daten werden in der Google Firebase Realtime Database in <strong>europe-west1 (Belgien, EU)</strong> gespeichert. Für japanische Teilnehmende ist dies eine grenzüberschreitende Übermittlung, die durch den EU–Japan-Angemessenheitsbeschluss (PPC, 2019) geschützt ist. Live-Sitzungsdaten werden innerhalb von 30 Tagen nach dem Ende der Sitzung gelöscht, bzw. innerhalb von 90 Tagen nach der Erstellung, wenn eine Sitzung nie beendet wird; wenn Sie das Forschungseinwilligungskästchen angekreuzt haben, werden Ihre Beiträge bis zu 5 Jahre nach der Veröffentlichung mit Ihrer Person verknüpft (identifizierbar) aufbewahrt. Eine Kopie verbleibt zudem bis zu 90 Tage nach ihrer Erstellung in unseren nächtlichen Sicherungen, sodass die letzte Kopie einer Sitzung etwa 120 Tage nach deren Ende verschwindet; Sicherungen dienen ausschließlich der Wiederherstellung des Dienstes nach einem Störfall, nie dem Nachschlagen von Daten.",
  "lobby.privacy.transcript": "Die Sitzungen finden per <strong>Videokonferenz über Microsoft Teams</strong> im Rahmen des Abonnements Ihrer Universität statt — <strong>Microsoft</strong> ist hierfür neben Google Auftragsverarbeiter. Das Werkzeug erstellt <strong>automatisch eine schriftliche Transkription</strong>, die Ihren Namen bei jedem Ihrer Wortbeiträge aufführt; die Audio-/Videoaufzeichnung der Sitzung wird ebenfalls aufbewahrt, nicht nur die Transkription. Transkription und Aufzeichnung werden <strong>nur aufbewahrt, wenn Sie das dritte Einwilligungskästchen ankreuzen</strong> — fünf Jahre lang nach der Veröffentlichung, mit denselben eingeschränkten Zugriffsrechten wie der übrige Forschungsdatensatz, und Sie können jederzeit ihre Löschung verlangen. <strong>Es wird keine Fotografie angefertigt, und Sie sind nicht verpflichtet, Ihre Kamera einzuschalten.</strong>",
  ...
  "splash.create.sections-help": "Die heutigen Abschnitte in Reihenfolge. Einführung und Abschluss sind immer enthalten.",
  "splash.create.sections-empty": "No sections yet — add at least one.",
  "splash.create.sections-add-label": "Einen einzelnen Abschnitt hinzufügen",
  "splash.create.sections-add": "+ Einen Abschnitt hinzufügen",
  "splash.create.case-label": "Fall",
  "splash.create.case-help": "Wählen Sie einen Fall, haken Sie die Teile an, die Sie heute durchführen, und fügen Sie sie hinzu. Unten können Sie sie noch umsortieren oder entfernen und Teile anderer Fälle mischen.",
  "splash.create.case-add": "+ Angehakte Teile hinzufügen",
  "splash.create.case-full": "{added} von {wanted} hinzugefügt — eine Sitzung hat höchstens {max} Abschnitte",
  "splash.create.sections-full": "Die Sitzung ist voll — höchstens {max} Abschnitte",
  ...
  "stage.label.welcome": "Willkommen",
  "stage.label.wrapup": "Abschluss",
  "stage.label.section": "Abschnitt {n} — {title}",
  "stage.label.0": "Willkommen",
  "stage.label.4": "Abschluss",
