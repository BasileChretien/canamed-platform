...
(function (root, factory) {
  ...
  "stage.wrap.reminder.title": "📅 復習リマインダーを予定する",
  "stage.wrap.reminder.hint": "3週間後に学生へ復習セルフチェックのリンクを送るためのリマインダーをカレンダーに追加しましょう — 間隔をあけた復習こそが学びを定着させます。",
  "stage.wrap.reminder.ics": "⤓ カレンダーに追加（.ics — Apple / Outlook）",
  "stage.wrap.reminder.gcal": "Google カレンダーに追加 →",
  "stage.wrap.reminder.linklabel": "学生に送るリンク：",
